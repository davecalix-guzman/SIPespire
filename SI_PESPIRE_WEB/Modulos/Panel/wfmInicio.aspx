...
CodeBehind="wfmInicio.aspx.cs"
Inherits="SI_PESPIRE_WEB.Modulos.Panel.wfmInicio" %>
            ...
            <div class="panel panel-flat">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <%--     <div class="col-md-6">
                            <h5><i class="fa fa-key"></i>&nbsp;Productos licenciados a ALIS</h5>

                            <table class="table table-striped table-bordered table-hover" style="height: 142px; background-color: #F0FFFF">
                                <thead>

                                    <tr>
                                        <th>Producto</th>
                                        <th>Total de licencias</th>
                                        <th>Licencias disponibles</th>
                                    </tr>
                                </thead>
                                <tr>
                                    <td>Estaciones de captura</td>
                                    <td>
                                        <asp:Label runat="server" ID="lblTotalEC"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label runat="server" ID="lblDisponiblesEC"></asp:Label>

                                    </td>
                                </tr>
                                <tr>
                                    <td>Estaciones de información</td>
                                    <td>
                                        <asp:Label runat="server" ID="lblTotalEI"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label runat="server" ID="lblDisponiblesEI"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                            <br />
