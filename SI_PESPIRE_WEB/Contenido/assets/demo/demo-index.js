jQuery(document).ready(function() {
    ...
    $("#chartist-tab a").on("shown.bs.tab",
        function(e) {
            Chartist1.update();
            Chartist2.update();
        });
    ...
    var responsiveSparklineTiles = function() {
        ...
        $("#sparkline-revenue").sparkline(
            [
                24, 19, 26, 28, 22, 19, 10, 13, 10, 15, 22, 26, 16, 22, 20, 27, 32, 31, 29, 22, 19, 8, 2, 5, 6, 14, 6,
                10, 13, 8, 19, 21, 26, 29, 24
            ],
            {
                type: "line",
                width: "100%",
        ...
        $("#sparkline-commission").sparkline(
            [
                27, 26, 21, 18, 8, 12, 10, 6, 15, 7, 6, 2, 8, 11, 13, 9, 14, 18, 27, 28, 26, 32, 22, 19, 18, 16, 19, 20,
                17, 24, 20, 29, 26, 20, 24
            ],
            {
                type: "line",
                width: "100%",
        ...
        $("#sparkline-item").sparkline(
            [5, 3, 9, 6, 5, 9, 7, 3, 5, 2, 5, 7, 5, 2, 5, 3, 9, 6, 5, 9, 7, 3, 5, 2, 5, 7, 5, 2],
            {
                type: "bar",
                barSpacing: 4,
                barWidth: 2,
    ...
    $("#sortable-todo .iCheck-helper, #completed-todo .iCheck-helper").on("click",
        function() {
            if ($(this)[0].dropped == true) {
                $(this)[0].dropped = false;
                return;
            }
    ...
    $("#daterangepicker2").daterangepicker({
        ...
        function(start, end) {
            $("#daterangepicker2 span").html(start.format("MMMM D, YYYY") +
                " - " +
    ...
    $("#sortable-tasks .iCheck-helper, #completed-tasks .iCheck-helper").on("click",
        function() {
            if ($(this)[0].dropped == true) {
                $(this)[0].dropped = false;
                return;
