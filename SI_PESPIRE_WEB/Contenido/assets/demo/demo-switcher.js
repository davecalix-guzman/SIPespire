$(function() {
    ...
    var sidebarColors =
        "sidebar-default sidebar-inverse sidebar-violet sidebar-green sidebar-info sidebar-midnightblue sidebar-grape sidebar-primary sidebar-alizarin sidebar-indigo navbar-default navbar-inverse navbar-primary navbar-violet navbar-alizarin navbar-grape navbar-danger navbar-green navbar-indigo navbar-info navbar-midnightblue";
    var headerColors =
        "navbar-default navbar-inverse navbar-primary navbar-violet navbar-alizarin navbar-grape navbar-danger navbar-green navbar-indigo navbar-info navbar-midnightblue";
    ...
    //Switch: Fixed Header
    $('input[name="demo-fixedheader"]').on("switchChange.bootstrapSwitch",
    ...
    //Switch: Boxed Layout
    $('input[name="demo-boxedlayout"]').on("switchChange.bootstrapSwitch",
        function(event, state) {
            //close infobar
    ...
    //Switch: Leftbar
    $('input[name="demo-collapseleftbar"]').on("switchChange.bootstrapSwitch",
        function(event, state) {
            Utility.toggle_leftbar();
        });

    //Switch: Rightbar
    $('input[name="demo-collapserightbar"]').on("switchChange.bootstrapSwitch",
        function(event, state) {
            Utility.toggle_rightbar();
        });

    //Switch Horizicons
    $('input[name="demo-horizicons"]').on("switchChange.bootstrapSwitch",
        function(event, state) {
    ...
    $(document).ready(function() {
        ...
        if (sideColor) {
            $(".static-sidebar-wrapper, .fixed-sidebar-wrapper").removeClass(sidebarColors)
                .addClass("sidebar-" + sideColor);
