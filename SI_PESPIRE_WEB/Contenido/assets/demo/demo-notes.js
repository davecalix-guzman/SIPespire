jQuery(document).ready(function() {
    ...
    var updateNoteList = function(notes) {
        ...
        for (var i = 0, length = notes.length; i < length; i++) {
            ...
            noteList += noteLiHtml.replace("%title%", title.substr(0, 20) + "...")
                .replace("%createdAt%", notes[i].createdAt);
        };
    ...
    $(".note > .scroll-content")[0].addEventListener("input",
        function() {
