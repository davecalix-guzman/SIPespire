$(function() {
    ...
    $("#infobar-earningsstats").sparkline(
        [
            120, 160, 130, 230, 170, 200, 80, 60, 150, 190, 240, 320, 290, 200, 240, 190, 130, 150, 230, 180, 80, 20,
            90, 110, 200, 240, 210, 250
        ],
        {
            type: "line",
            lineColor: "#6678c1",
    ...
    $("#infobar-orderstats").sparkline(
        [
            240, 200, 230, 180, 170, 120, 90, 30, 100, 120, 180, 150, 190, 270, 280, 320, 250, 170, 230, 170, 90, 110,
            200, 190, 220, 110, 150, 130
        ],
        {
            type: "line",
            lineColor: "#7f96a0",
        ...
        function() {
            navigator.geolocation.getCurrentPosition(function(position) {
                loadWeather(position.coords.latitude +
                    "," +
                    position.coords.longitude); //load weather using your lat/lng coordinates
            });
        });
