$(function() {
    ...
    var sparker = function() {
        ...
        // Discrete charts
        $("#discrete1").sparkline("html", { type: "discrete", lineColor: "blue", width: 18 });
        ...
        $("#bigstacked").sparkline([5, 4, 7, 6, 9, 5, 8, 2, 6, 4, 6, 7, 6, 4, 2, 1, 4, 6, 2, 5, 7, 2, 3, 5, 3, 7, 9],
            {
                type: "bar",
                barColor: "#aaf",
                height: "200px",
        ...
        $("#bigstacked").sparkline([4, 1, 5, 7, 9, 9, 8, 7, 6, 6, 4, 7, 8, 4, 3, 2, 2, 5, 6, 7, 8],
            { composite: true, fillColor: false, lineColor: "red", height: "200px", lineWidth: 2, width: "100%" });
    };
