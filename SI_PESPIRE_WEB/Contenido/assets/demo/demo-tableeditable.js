...
// -------------------------------
    ...
    $("#panel-inline .panel-ctrls").append($("#panel-inline .dataTables_filter").addClass("pull-right")).find("label")
        .addClass("panel-ctrls-center");
    $("#panel-inline .panel-ctrls").append("<i class='separator'></i>");
    $("#panel-inline .panel-ctrls").append($("#panel-inline .dataTables_length").addClass("pull-left")).find("label")
        .addClass("panel-ctrls-center");
...
//-------------------------
    ...
    //DOM Manipulation to move datatable elements integrate to panel
    $("#panel-editable .panel-ctrls").append($("#panel-editable .dataTables_filter").addClass("pull-right"))
