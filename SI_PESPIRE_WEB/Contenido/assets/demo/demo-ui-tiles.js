...
var responsiveSparklinePageView = function() {
    ...
    $("#spark-tile-revenue").sparkline(
        [5, 6, 7, 9, 9, 5, 3, 2, 2, 4, 6, 7, 5, 6, 7, 9, 9, 5, 3, 2, 2, 4, 6, 7, 5, 6, 5, 3],
        {
            type: "line",
            width: "100%",
            fillColor: "#aed581",
    ...
    $("#sparkline-revenue").sparkline(
        [
            24, 19, 26, 28, 22, 19, 10, 13, 10, 15, 22, 26, 16, 22, 20, 27, 32, 31, 29, 22, 19, 8, 2, 5, 6, 14, 6, 10,
            13, 8, 19, 21, 26, 29, 24
        ],
        {
            type: "line",
    ...
    $("#sparkline-commission").sparkline(
        [
            27, 26, 21, 18, 8, 12, 10, 6, 15, 7, 6, 2, 8, 11, 13, 9, 14, 18, 27, 28, 26, 32, 22, 19, 18, 16, 19, 20, 17,
            24, 20, 29, 26, 20, 24
        ],
        {
            type: "line",
