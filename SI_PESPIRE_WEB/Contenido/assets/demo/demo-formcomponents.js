...
$(function() {
    ...
    Switchery(document.querySelector(".xs .js-switch-primary"), { color: Utility.getBrandColor("primary") });
    Switchery(document.querySelector(".xs .js-switch-success"), { color: Utility.getBrandColor("success") });
    Switchery(document.querySelector(".xs .js-switch-warning"), { color: Utility.getBrandColor("warning") });
    Switchery(document.querySelector(".xs .js-switch-info"), { color: Utility.getBrandColor("info") });
    Switchery(document.querySelector(".xs .js-switch-danger"), { color: Utility.getBrandColor("danger") });
    Switchery(document.querySelector(".xs .js-switch-inverse"), { color: Utility.getBrandColor("inverse") });

    Switchery(document.querySelector(".nm .js-switch-primary"), { color: Utility.getBrandColor("primary") });
    Switchery(document.querySelector(".nm .js-switch-success"), { color: Utility.getBrandColor("success") });
    Switchery(document.querySelector(".nm .js-switch-warning"), { color: Utility.getBrandColor("warning") });
    Switchery(document.querySelector(".nm .js-switch-info"), { color: Utility.getBrandColor("info") });
    Switchery(document.querySelector(".nm .js-switch-danger"), { color: Utility.getBrandColor("danger") });
    Switchery(document.querySelector(".nm .js-switch-inverse"), { color: Utility.getBrandColor("inverse") });
    ...
    var engine = new Bloodhound({
        local: [
            { value: "red" }, { value: "blue" }, { value: "green" }, { value: "yellow" }, { value: "violet" },
            { value: "brown" }, { value: "purple" }, { value: "black" }, { value: "white" }
        ],
    ...
    $("#e7").select2({
        ...
        escapeMarkup:
            function(m) { return m; } // we do not want to escape markup since we are displaying html in results
    });
    ...
    $("#multi-select").multiSelect({
        selectableHeader:
            "<input type='text' class='form-control' style='margin-bottom: 10px;'  autocomplete='off' placeholder='Filter entries...'>",
        selectionHeader:
            "<input type='text' class='form-control' style='margin-bottom: 10px;' autocomplete='off' placeholder='Filter entries...'>",
