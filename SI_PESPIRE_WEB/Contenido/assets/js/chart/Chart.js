                            ...
                            updateElement: function(rectangle, index, reset) {
                                ...
                                rectangle._model = {
                                    ...
                                    backgroundColor: custom.backgroundColor
                                        ...
                                        : helpers.getValueAtIndexOrDefault(dataset.backgroundColor,
                                            index,
                                            rectangleOptions.backgroundColor),
                                    borderColor: custom.borderColor
                                        ? custom.borderColor
                                        : helpers.getValueAtIndexOrDefault(dataset.borderColor,
                                            index,
                                            rectangleOptions.borderColor),
                                    borderWidth: custom.borderWidth
                                        ? custom.borderWidth
                                        : helpers.getValueAtIndexOrDefault(dataset.borderWidth,
                                            index,
                        ...
                        Chart.controllers.bubble = Chart.DatasetController.extend({
                                ...
                                helpers.extend(point,
                                    {
                                        ...
                                        _model: {
                                            x: reset
                                                ...
                                                : xScale.getPixelForValue(typeof data === "object" ? data : NaN,
                                                    index,
                                                    dsIndex,
                                                    me.chart.isCombo),
                                            y: reset
                                            ...
                                            hitRadius: custom.hitRadius
                                                ? custom.hitRadius
                                                : helpers.getValueAtIndexOrDefault(dataset.hitRadius,
                                                    index,
                            ...
                            setHoverStyle: function(point) {
                                ...
                                model.radius =
                                    custom.hoverRadius
                                    ? custom.hoverRadius
                                    : (helpers.getValueAtIndexOrDefault(dataset.hoverRadius,
                                        index,
                            ...
                            removeHoverStyle: function(point) {
                                var me = this;
                                Chart.DatasetController.prototype.removeHoverStyle.call(me,
                                    point,
                                        ...
                                        if (data.labels.length && data.datasets.length) {
                                            return data.labels.map(function(label, i) {
                                                ...
                                                var fill = custom.backgroundColor
                                                    ? custom.backgroundColor
                                                    : getValueAtIndexOrDefault(ds.backgroundColor,
                                                        i,
                        ...
                        Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend({
                            ...
                            update: function(reset) {
                                ...
                                if (circumference < Math.PI * 2.0) {
                                    ...
                                    var contains0 = (startAngle <= 0 && 0 <= endAngle) ||
                                    ...
                                    var contains180 = (startAngle <= -Math.PI && -Math.PI <= endAngle) ||
                                    ...
                                    var min = {
                                        x: contains180
                                            ? -1
                                            : Math.min(start.x * (start.x < 0 ? 1 : cutout),
                                                end.x * (end.x < 0 ? 1 : cutout)),
                                        y: contains270
                                            ? -1
                                            : Math.min(start.y * (start.y < 0 ? 1 : cutout),
                                                end.y * (end.y < 0 ? 1 : cutout))
                                    };
                                    var max = {
                                        x: contains0
                                            ? 1
                                            : Math.max(start.x * (start.x > 0 ? 1 : cutout),
                                                end.x * (end.x > 0 ? 1 : cutout)),
                                        y: contains90
                                            ? 1
                                            : Math.max(start.y * (start.y > 0 ? 1 : cutout),
                                                end.y * (end.y > 0 ? 1 : cutout))
                                    };
                                ...
                                chart.innerRadius =
                                    Math.max(cutoutPercentage ? (chart.outerRadius / 100) * (cutoutPercentage) : 0, 0);
                                chart.radiusLength =
                            ...
                            removeHoverStyle: function(arc) {
                                Chart.DatasetController.prototype.removeHoverStyle.call(this,
                                    arc,
                            ...
                            getMaxBorderWidth: function(elements) {
                                ...
                                for (var i = 0; i < length; i++) {
                                    ...
                                    hoverWidth =
                                        elements[i]._chart
                                        ? elements[i]._chart.config.data.datasets[index].hoverBorderWidth
                                        : 0;
                        ...
                        Chart.controllers.line = Chart.DatasetController.extend({
                                ...
                                if (showLine) {
                                    ...
                                    line._model = {
                                        ...
                                        tension: custom.tension
                                            ? custom.tension
                                            : helpers.getValueOrDefault(dataset.lineTension,
                                        ...
                                        steppedLine: custom.steppedLine
                                            ? custom.steppedLine
                                            : helpers.getValueOrDefault(dataset.steppedLine,
                            ...
                            getPointBackgroundColor: function(point, index) {
                                ...
                                if (custom.backgroundColor) {
                                    ...
                                    backgroundColor = helpers.getValueAtIndexOrDefault(dataset.pointBackgroundColor,
                                        index,
                                        backgroundColor);
                            ...
                            updateElement: function(point, index, reset) {
                                ...
                                var includeOffset = (labels.length === 1 || dataset.data.length === 1) ||
                                    me.chart.isCombo;
                                ...
                                x = xScale.getPixelForValue(typeof value === "object" ? value : NaN,
                                    index,
                                    datasetIndex,
                                    includeOffset);
                                ...
                                point._model = {
                                    ...
                                    radius: custom.radius ||
                                        helpers.getValueAtIndexOrDefault(dataset.pointRadius,
                                            index,
                                            pointOptions.radius),
                                    pointStyle: custom.pointStyle ||
                                        helpers.getValueAtIndexOrDefault(dataset.pointStyle,
                                            index,
                                    ...
                                    // Tooltip
                                    hitRadius: custom.hitRadius ||
                                        helpers.getValueAtIndexOrDefault(dataset.pointHitRadius,
                                            index,
                            ...
                            setHoverStyle: function(point) {
                                ...
                                model.radius =
                                    custom.hoverRadius ||
                                    helpers.getValueAtIndexOrDefault(dataset.pointHoverRadius,
                                        index,
                                        this.chart.options.elements.point.hoverRadius);
                                model.backgroundColor = custom.hoverBackgroundColor ||
                                    helpers.getValueAtIndexOrDefault(dataset.pointHoverBackgroundColor,
                                        index,
                                        helpers.getHoverColor(model.backgroundColor));
                                model.borderColor = custom.hoverBorderColor ||
                                    helpers.getValueAtIndexOrDefault(dataset.pointHoverBorderColor,
                                        index,
                                        helpers.getHoverColor(model.borderColor));
                                model.borderWidth = custom.hoverBorderWidth ||
                                    helpers.getValueAtIndexOrDefault(dataset.pointHoverBorderWidth,
                                        index,
                                        model.borderWidth);
                            },
                    ...
                    module.exports = function(Chart) {
                        ...
                        Chart.controllers.polarArea = Chart.DatasetController.extend({
                            ...
                            update: function(reset) {
                                ...
                                var minSize = Math.min(chartArea.right - chartArea.left,
                            ...
                            updateElement: function(arc, index, reset) {
                                ...
                                var distance =
                                    arc.hidden ? 0 : scale.getDistanceFromCenterForValue(dataset.data[index]);
                    ...
                    module.exports = function(Chart) {
                        ...
                        Chart.controllers.radar = Chart.DatasetController.extend({
                            ...
                            updateElement: function(point, index, reset) {
                                ...
                                helpers.extend(point,
                                    {
                                        ...
                                        _model: {
                                            ...
                                            backgroundColor: custom.backgroundColor
                                                ? custom.backgroundColor
                                                : helpers.getValueAtIndexOrDefault(dataset.pointBackgroundColor,
                                                    index,
                                                    pointElementOptions.backgroundColor),
                                            borderColor: custom.borderColor
                                                ? custom.borderColor
                                                : helpers.getValueAtIndexOrDefault(dataset.pointBorderColor,
                                                    index,
                                                    pointElementOptions.borderColor),
                                            borderWidth: custom.borderWidth
                                                ? custom.borderWidth
                                                : helpers.getValueAtIndexOrDefault(dataset.pointBorderWidth,
                                                    index,
                                ...
                                point._model.skip =
                                    custom.skip ? custom.skip : (isNaN(point._model.x) || isNaN(point._model.y));
                            },
                            updateBezierControlPoints: function() {
                                ...
                                helpers.each(meta.data,
                                    function(point, index) {
                                        ...
                                        model.controlPointPreviousX =
                                            Math.max(Math.min(controlPoints.previous.x, chartArea.right),
                                                chartArea.left);
                                        model.controlPointPreviousY =
                                            Math.max(Math.min(controlPoints.previous.y, chartArea.bottom),
                                                chartArea.top);
...
/* global window: false */
                    ...
                    module.exports = function(Chart) {
                         ...
                         */
                        Object.defineProperty(Chart.Animation.prototype,
                            "animationObject",
                            {
                                get: function() {
                                    return this;
                        ...
                        helpers.extend(Chart.prototype, /** @lends Chart */
                            {
                                ...
                                resize: function(silent) {
                                    ...
                                    var newHeight = Math.floor(aspectRatio
                                ...
                                */
                                ...
                                bindEvents: function() {
                                    ...
                                    helpers.each(me.options.events,
                                        function(type) {
                        ...
                        helpers.extend(Chart.DatasetController.prototype,
                            {
                                ...
                                setHoverStyle: function(element) {
                                    ...
                                    model.backgroundColor = custom.hoverBackgroundColor
                                        ? custom.hoverBackgroundColor
                                        : valueOrDefault(dataset.hoverBackgroundColor,
                                            index,
                                            getHoverColor(model.backgroundColor));
                                    model.borderColor =
                                        custom.hoverBorderColor
                                        ? custom.hoverBorderColor
                                        : valueOrDefault(dataset.hoverBorderColor,
                                            index,
...
/* global document: false */
                    ...
                    module.exports = function(Chart) {
                                    ...
                                    helpers.each(extension,
                                        function(value, key) {
                                            ...
                                            if (key === "scales") {
                                                ...
                                                base[key] = helpers.configMerge(baseVal,
                                ...
                                function(value, key) {
                                    if (key === "xAxes" || key === "yAxes") {
                                        ...
                                        if (base.hasOwnProperty(key)) {
                                            helpers.each(value,
                                                function(valueObj, index) {
                                                    var axisType = helpers.getValueOrDefault(valueObj.type,
                                                    ...
                                                    if (index >= base[key].length || !base[key][index].type) {
                                                        ...
                                                        base[key][index] = helpers.configMerge(base[key][index],
                                                            axisDefaults,
                                                            valueObj);
                                                    } else {
                                                        // Type is the same
                                            ...
                                            helpers.each(value,
                                                function(valueObj) {
                                                    var axisType = helpers.getValueOrDefault(valueObj.type,
                                                        key === "xAxes" ? "category" : "linear");
                                                    base[key].push(helpers.configMerge(
                        ...
                        helpers.inherits = function(extensions) {
                            ...
                            var me = this;
                            var ChartElement = (extensions && extensions.hasOwnProperty("constructor"))
                        ...
                        var easingEffects = helpers.easingEffects = {
                            ...
                            easeInOutElastic: function(t) {
                                ...
                                if (t < 1) {
                                    return -0.5 *
                                        (a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * 1 - s) * (2 * Math.PI) / p));
                                }
                                return a *
                                    Math.pow(2, -10 * (t -= 1)) *
                        ...
                        helpers.getRelativePosition = function(evt, chart) {
                            ...
                            mouseX = Math.round((mouseX - boundingRect.left - paddingLeft) /
                                (width) *
                                canvas.width /
                                chart.currentDevicePixelRatio);
                            mouseY = Math.round((mouseY - boundingRect.top - paddingTop) /
                                (height) *
                                canvas.height /
                                chart.currentDevicePixelRatio);
                        ...
                        Chart.layoutService = {
                            ...
                            update: function(chart, width, height) {
                                ...
                                function getMinimumBoxSize(box) {
                                    ...
                                    if (isHorizontal) {
                                        minSize = box.update(box.fullWidth ? chartWidth : maxChartAreaWidth,
                                            horizontalBoxHeight);
                                ...
                                helpers.each(topBoxes.concat(bottomBoxes),
                                    function(horizontalBox) {
                                        if (horizontalBox.getPadding) {
                                            var boxPadding = horizontalBox.getPadding();
                                            maxHorizontalLeftPadding =
                                                Math.max(maxHorizontalLeftPadding, boxPadding.left);
                                            maxHorizontalRightPadding =
                                                Math.max(maxHorizontalRightPadding, boxPadding.right);
                                        }
                                    });

                                helpers.each(leftBoxes.concat(rightBoxes),
                                    function(verticalBox) {
                                        if (verticalBox.getPadding) {
                                            var boxPadding = verticalBox.getPadding();
                                            maxVerticalTopPadding = Math.max(maxVerticalTopPadding, boxPadding.top);
                                            maxVerticalBottomPadding =
                                                Math.max(maxVerticalBottomPadding, boxPadding.bottom);
                                        }
                                    });
                                ...
                                function fitBox(box) {
                                    var minBoxSize = helpers.findNextWhere(minBoxSizes,
                                        function(minBox) {
                                    ...
                                    if (minBoxSize) {
                                        if (box.isHorizontal()) {
                                            ...
                                            box.update(box.fullWidth ? chartWidth : maxChartAreaWidth,
                                                chartHeight / 2,
                                                scaleMargin);
                                        } else {
                                ...
                                helpers.each(leftBoxes,
                                    function(box) {
                                        totalLeftBoxesWidth += box.width;
                                    });

                                helpers.each(rightBoxes,
                                    function(box) {
                                ...
                                totalBottomBoxesHeight += Math.max(maxVerticalBottomPadding - totalBottomBoxesHeight,
                                    0);
                                ...
                                if (newMaxChartAreaWidth !== maxChartAreaWidth ||
                        ...
                        Chart.Scale = Chart.Element.extend({
                            ...
                            calculateTickRotation: function() {
                                ...
                                if (me.options.display && me.isHorizontal()) {
                                    var originalLabelWidth = helpers.longestText(context,
                                        tickFont.font,
                                        me.ticks,
                                        me.longestTextCache);
                            ...
                            fit: function() {
                                ...
                                if (tickOpts.display && display) {
                                    var largestTextWidth = helpers.longestText(me.ctx,
                                        tickFont.font,
                                        me.ticks,
                                        me.longestTextCache);
                                    ...
                                    if (isHorizontal) {
                                        ...
                                        if (me.labelRotation !== 0) {
                                            me.paddingLeft =
                                                ...
                                                3; // add 3 px to move away from canvas edges
                                            me.paddingRight =
                                                opts.position === "bottom"
                            ...
                            getPixelForTick: function(index, includeOffset) {
                                ...
                                if (me.isHorizontal()) {
                                    ...
                                    var tickWidth = innerWidth /
                                        Math.max((me.ticks.length - ((me.options.gridLines.offsetGridLines) ? 0 : 1)),
                                            1);
                            ...
                            draw: function(chartArea) {
                                ...
                                var tickFontColor = helpers.getValueOrDefault(optionTicks.fontColor,
                                ...
                                if (isHorizontal) {
                                    ...
                                    if ((longestRotatedLabel + optionTicks.autoSkipPadding) * me.ticks.length >
                                        (me.width - (me.paddingLeft + me.paddingRight))) {
                                        skipRatio = 1 +
                                            Math.floor(((longestRotatedLabel + optionTicks.autoSkipPadding) *
                                                    me.ticks.length) /
                                                (me.width - (me.paddingLeft + me.paddingRight)));
                                    }
                                ...
                                helpers.each(me.ticks,
                                    function(label, index) {
                                        ...
                                        var shouldSkip = (skipRatio > 1 && index % skipRatio > 0) ||
                                            (index % skipRatio === 0 && index + skipRatio >= me.ticks.length);
                                        ...
                                        if (index === (typeof me.zeroLineIndex !== "undefined" ? me.zeroLineIndex : 0)
                                            ...
                                            borderDash =
                                                helpers.getValueOrDefault(gridLines.borderDash,
                                                    globalDefaults.borderDash);
                                            borderDashOffset = helpers.getValueOrDefault(gridLines.borderDashOffset,
                                        ...
                                        if (isHorizontal) {
                                            ...
                                            var xLineValue =
                                                me.getPixelForTick(index) +
                                                    helpers.aliasPixel(lineWidth); // xvalues for grid lines
                                            labelX = me.getPixelForTick(index, gridLines.offsetGridLines) +
                                                optionTicks
                                                .labelOffset; // x values for optionTicks (need to consider offsetLabel option)
                            ...
                            generators: {
                                ...
                                linear: function(generationOptions, dataRange) {
                                    ...
                                    if (generationOptions.min && generationOptions.max && generationOptions.stepSize) {
                                        ...
                                        if (helpers.almostWhole((generationOptions.max - generationOptions.min) /
                                ...
                                logarithmic: function(generationOptions, dataRange) {
                                    ...
                                    // the graph
                                    var tickVal = getValueOrDefault(generationOptions.min,
                            ...
                            formatters: {
                                ...
                                linear: function(tickValue, index, ticks) {
                                    ...
                                    if (tickValue !== 0) {
                                        ...
                                        numDecimal =
                                            Math.max(Math.min(numDecimal, 20),
                                                0); // toFixed has a max of 20 decimal places
                    ...
                    module.exports = function(Chart) {
                        ...
                        function getBaseModel(tooltipOpts) {
                            ...
                            return {
                                ...
                                _bodyFontFamily: getValueOrDefault(tooltipOpts.bodyFontFamily,
                                    globalDefaults.defaultFontFamily),
                                _bodyFontStyle: getValueOrDefault(tooltipOpts.bodyFontStyle,
                                    globalDefaults.defaultFontStyle),
                                _bodyAlign: tooltipOpts.bodyAlign,
                                bodyFontSize: getValueOrDefault(tooltipOpts.bodyFontSize,
                                    globalDefaults.defaultFontSize),
                                bodySpacing: tooltipOpts.bodySpacing,

                                // Title
                                titleFontColor: tooltipOpts.titleFontColor,
                                _titleFontFamily: getValueOrDefault(tooltipOpts.titleFontFamily,
                                    globalDefaults.defaultFontFamily),
                                _titleFontStyle: getValueOrDefault(tooltipOpts.titleFontStyle,
                                    globalDefaults.defaultFontStyle),
                                titleFontSize: getValueOrDefault(tooltipOpts.titleFontSize,
                                    globalDefaults.defaultFontSize),
                                ...
                                _footerFontFamily: getValueOrDefault(tooltipOpts.footerFontFamily,
                                    globalDefaults.defaultFontFamily),
                                _footerFontStyle: getValueOrDefault(tooltipOpts.footerFontStyle,
                                    globalDefaults.defaultFontStyle),
                                footerFontSize: getValueOrDefault(tooltipOpts.footerFontSize,
                                    globalDefaults.defaultFontSize),
                        ...
                        function getTooltipSize(tooltip, model) {
                            ...
                            // Footer width
                            ctx.font = helpers.fontString(footerFontSize,
                        ...
                        function determineAlignment(tooltip, size) {
                            ...
                            var
                                yf; // function to get the y alignment if the tooltip goes outside of the left or right edges
                        ...
                        Chart.Tooltip = Chart.Element.extend({
                            ...
                            update: function(changed) {
                                ...
                                if (active.length) {
                                    ...
                                    var labelColors = [];
                                    tooltipPosition =
                                        Chart.Tooltip.positioners[opts.position](active, me._eventPosition);
                            ...
                            drawTitle: function(pt, vm, ctx, opacity) {
                                ...
                                if (title.length) {
                                    ...
                                    ctx.font = helpers.fontString(titleFontSize,
                                        vm._titleFontStyle,
                                        vm._titleFontFamily);
                                    ...
                                    for (i = 0, len = title.length; i < len; ++i) {
                                        ...
                                        if (i + 1 === title.length) {
                                            pt.y += vm.titleMarginBottom -
                                                titleSpacing; // If Last, add margin, remove spacing
                                        }
                                    }
                                }
                            },
                                        ...
                                        helpers.each(bodyItem.lines,
                                            function(line) {
                                                ...
                                                if (drawColorBoxes) {
                                                    ...
                                                    // Border
                                                    ctx.strokeStyle =
                                                        mergeOpacity(vm.labelColors[i].borderColor, opacity);
                                                    ctx.strokeRect(pt.x, pt.y, bodyFontSize, bodyFontSize);

                                                    // Inner square
                                                    ctx.fillStyle =
                                                        mergeOpacity(vm.labelColors[i].backgroundColor, opacity);
                                                    ctx.fillRect(pt.x + 1,
                                                        pt.y + 1,
                                                        bodyFontSize - 2,
                                                        bodyFontSize - 2);
                    ...
                    module.exports = function(Chart) {
                        ...
                        Chart.elements.Point = Chart.Element.extend({
                            ...
                            draw: function(chartArea) {
                                ...
                                ctx.lineWidth =
                                    helpers.getValueOrDefault(vm.borderWidth, globalOpts.elements.point.borderWidth);
                                    ...
                                    if (isHorizontal) {
                                        ...
                                        helpers.each(me.legendItems,
                                            function(legendItem, i) {
                                                ...
                                                if (lineWidths[lineWidths.length - 1] + width + labelOpts.padding >=
                                                    me.width) {
                            ...
                            draw: function() {
                                ...
                                if (opts.display) {
                                    var ctx = me.ctx,
                                        ...
                                        fontSize = itemOrDefault(labelOpts.fontSize, globalDefault.defaultFontSize),
                                        fontStyle = itemOrDefault(labelOpts.fontStyle, globalDefault.defaultFontStyle),
                                        fontFamily = itemOrDefault(labelOpts.fontFamily,
                                    ...
                                    var drawLegendBox = function(x, y, legendItem) {
                                        ...
                                        ctx.lineDashOffset =
                                            itemOrDefault(legendItem.lineDashOffset, lineDefault.borderDashOffset);
                                        ctx.lineJoin = itemOrDefault(legendItem.lineJoin, lineDefault.borderJoinStyle);
                                        ctx.lineWidth = itemOrDefault(legendItem.lineWidth, lineDefault.borderWidth);
                                        ctx.strokeStyle =
                                            itemOrDefault(legendItem.strokeStyle, globalDefault.defaultColor);
                                        var isLineWidthZero =
                                            (itemOrDefault(legendItem.lineWidth, lineDefault.borderWidth) === 0);
                                        ...
                                        if (opts.labels && opts.labels.usePointStyle) {
                                            ...
                                            Chart.canvasHelpers.drawPoint(ctx,
                        ...
                        Chart.Title = Chart.Element.extend({
                            ...
                            draw: function() {
                                ...
                                if (opts.display) {
                                    ...
                                    ctx.fillStyle =
                                        valueOrDefault(opts.fontColor,
                                            globalDefaults.defaultFontColor); // render in correct colour
                                    ctx.font = titleFont;
                        ...
                        var DatasetScale = Chart.Scale.extend({
                            ...
                            */
                            ...
                            buildTicks: function() {
                                ...
                                me.ticks = (me.minIndex === 0 && me.maxIndex === labels.length - 1)
                                    ? labels
                            ...
                            getPixelForValue: function(value, index, datasetIndex, includeOffset) {
                                ...
                                var offsetAmt = Math.max((me.maxIndex +
                                        1 -
                                        me.minIndex -
                            ...
                            getPixelForTick: function(index, includeOffset) {
                                return this.getPixelForValue(this.ticks[index],
                                    index + this.minIndex,
                                    null,
                                    includeOffset);
                            },
                        ...
                        var LinearScale = Chart.LinearScaleBase.extend({
                            determineDataLimits: function() {
                                ...
                                if (opts.stacked || hasStacks) {
                                    ...
                                    helpers.each(valuesPerStack,
                                        function(valuesForType) {
                                            var values =
                                                valuesForType.positiveValues.concat(valuesForType.negativeValues);
                            ...
                            getTickLimit: function() {
                                ...
                                if (me.isHorizontal()) {
                                    maxTicks = Math.min(tickOpts.maxTicksLimit ? tickOpts.maxTicksLimit : 11,
                ...
                function(require, module, exports) {
                    ...
                    module.exports = function(Chart) {
                        ...
                        function getPointLabelFontOptions(scale) {
                            ...
                            var fontSize =
                                helpers.getValueOrDefault(pointLabelOptions.fontSize, globalDefaults.defaultFontSize);
                            var fontStyle = helpers.getValueOrDefault(pointLabelOptions.fontStyle,
                                globalDefaults.defaultFontStyle);
                            var fontFamily = helpers.getValueOrDefault(pointLabelOptions.fontFamily,
                                globalDefaults.defaultFontFamily);
                        ...
                        function drawPointLabels(scale) {
                            ...
                            var outerDistance =
                                scale.getDistanceFromCenterForValue(opts.reverse ? scale.min : scale.max);
                            ...
                            for (var i = getValueCount(scale) - 1; i >= 0; i--) {
                                ...
                                if (pointLabelOpts.display) {
                                    ...
                                    var pointLabelFontColor = getValueOrDefault(pointLabelOpts.fontColor,
                                        globalDefaults.defaultFontColor);
                        ...
                        var LinearRadialScale = Chart.LinearScaleBase.extend({
                            setDimensions: function() {
                                ...
                                var tickFontSize =
                                    helpers.getValueOrDefault(tickOpts.fontSize, globalDefaults.defaultFontSize);
                                me.drawingArea =
                                    opts.display
                            ...
                            determineDataLimits: function() {
                                ...
                                helpers.each(chart.data.datasets,
                                    function(dataset, datasetIndex) {
                                        if (chart.isDatasetVisible(datasetIndex)) {
                                            var meta = chart.getDatasetMeta(datasetIndex);
                            ...
                            getTickLimit: function() {
                                ...
                                var tickFontSize =
                                    helpers.getValueOrDefault(tickOpts.fontSize, globalDefaults.defaultFontSize);
                                return Math.min(tickOpts.maxTicksLimit ? tickOpts.maxTicksLimit : 11,
                            ...
                            setReductions: function(largestPossibleRadius, furthestLimits, furthestAngles) {
                                ...
                                me.drawingArea = Math.min(
                                    Math.round(largestPossibleRadius -
                            ...
                            draw: function() {
                                ...
                                if (opts.display) {
                                    ...
                                    // Tick Font
                                    var tickFontSize = getValueOrDefault(tickOpts.fontSize,
                                        globalDefaults.defaultFontSize);
                                    var tickFontStyle =
                                        getValueOrDefault(tickOpts.fontStyle, globalDefaults.defaultFontStyle);
                                    var tickFontFamily = getValueOrDefault(tickOpts.fontFamily,
                                        globalDefaults.defaultFontFamily);
                                    ...
                                    helpers.each(me.ticks,
                                        function(label, index) {
                                            ...
                                            if (index > 0 || opts.reverse) {
                                                ...
                                                if (tickOpts.display) {
                                                    var tickFontColor = getValueOrDefault(tickOpts.fontColor,
                                                        globalDefaults.defaultFontColor);
...
/* global window: false */
                    ...
                    module.exports = function(Chart) {
                        ...
                        var defaultConfig = {
                            ...
                            time: {
                                parser:
                                    false, // false == a pattern string from http://momentjs.com/docs/#/parsing/string-format/ or a custom callback that converts its argument to a moment
                                format:
                                    false, // DEPRECATED false == date objects, moment object, callback or a pattern string from http://momentjs.com/docs/#/parsing/string-format/
                                unit: false, // false == automatic or override with week, month, year, etc.
                                round: false, // none, or override with week, month, year, etc.
                                displayFormat: false, // DEPRECATED
                                isoWeekday:
                                    false, // override week start day - see http://momentjs.com/docs/#/get-set/iso-weekday/
                                minUnit: "millisecond",
                        ...
                        function determineUnit(minUnit, min, max, maxTicks) {
                            ...
                            for (var i = units.indexOf(minUnit); i < numUnits; i++) {
                                ...
                                var steps = (unitDetails.steps && unitDetails.steps[unitDetails.steps.length - 1]) ||
                                    unitDetails.maxStep;
                                if (steps === undefined ||
                                    Math.ceil((max - min) / (steps * unitDetails.size)) <= maxTicks) {
                                    break;
                                }
                            }
                        ...
                        var TimeScale = Chart.Scale.extend({
                            ...
                            determineDataLimits: function() {
                                ...
                                helpers.each(chartData.datasets,
                                    function(dataset, datasetIndex) {
                                        var timestamps = [];
                            ...
                            buildTicks: function() {
                                ...
                                var unit = timeOpts.unit ||
                                    determineUnit(timeOpts.minUnit,
                                        minTimestamp || dataMin,
                                        maxTimestamp || dataMax,
                                        maxTicks);
                                me.displayFormat = timeOpts.displayFormats[unit];

                                var stepSize = timeOpts.stepSize ||
                                    determineStepSize(minTimestamp || dataMin, maxTimestamp || dataMax, unit, maxTicks);
                            ...
                            getLabelForIndex: function(index, datasetIndex) {
                                var me = this;
                                var label = me.chart.data.labels && index < me.chart.data.labels.length
                            ...
                            getLabelWidth: function(label) {
                                ...
                                var tickFontSize =
                                    helpers.getValueOrDefault(ticks.fontSize, Chart.defaults.global.defaultFontSize);
                            ...
                            getLabelCapacity: function(exampleTime) {
                                ...
                                me.displayFormat =
                                    me.options.time.displayFormats
                                    .millisecond; // Pick the longest format for guestimation
