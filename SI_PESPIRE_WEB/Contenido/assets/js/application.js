...
!function(a, b) {
    ...
    if (a.uaMatch = function(a) {
        ...
        }, c = a.uaMatch(b.navigator.userAgent), d =
            {}, c.browser && (d[c.browser] = !0, d.version = c.version, d.versionNumber = parseInt(c.version)),
        c.platform && (d[c.platform] = !0), (d.android || d.ipad || d.iphone || d["windows phone"]) && (d.mobile = !0),
...
$(document).ready(function() {
    ...
    // ------------------------------
    $("body").on("click",
        ".yamm .dropdown-menu, .dropdown-menu-form",
        function(e) {
            e.stopPropagation();
        });
    ...
    $(".project-switcher").on("show.bs.dropdown",
        function(e) {
            $(this).find(".dropdown-menu").first().stop(true, true).slideDown(200);
        });

    // ADD SLIDEUP ANIMATION TO DROPDOWN //
    $(".project-switcher").on("hide.bs.dropdown",
        function(e) {
