...
(function($) {
    ...
    function doRightClick() {
        ...
        simulatedEvent.initMouseEvent("mouseup",
            true,
            true,
            window,
            1,
        ...
        simulatedEvent = document.createEvent("MouseEvent");
        simulatedEvent.initMouseEvent("mousedown",
            true,
            true,
            window,
            1,
        ...
        // Show a context menu
        simulatedEvent = document.createEvent("MouseEvent");
        simulatedEvent.initMouseEvent("contextmenu",
            true,
            true,
            window,
            1,
    ...
    function getDOMElementFromEvent(event) {
        if (event.targetTouches && event.targetTouches[0]) {
            return document.elementFromPoint(event.targetTouches[0].pageX - window.pageXOffset,
                event.targetTouches[0].pageY - window.pageYOffset);
        }
        return null;
    }
    ...
    function iPadTouchHandler(event) {
        ...
        ) { // This actually emulates the ipad's default behavior (which we prevented)
            simulatedEvent =
                document.createEvent("MouseEvent"); // This check avoids click being emulated on a double tap
