    ...
    $.jstree.core.prototype = {
        ...
        init: function(el, options) {
            ...
            this.element.html("<" +
                ...
                "li class='jstree-initial-node jstree-loading jstree-leaf jstree-last'><i class='jstree-icon jstree-ocl'></i><" +
            ...
            this.element
                            ...
                            case 39:
                                ...
                                if (this.is_closed(e.currentTarget)) {
                                    this.open_node(e.currentTarget,
                                        function(o) { this.get_node(o, true).children('.jstree-anchor').focus(); });
                                } else {
                                ...
                                if (!this._data.core.ready &&
                                    ...
                                    if (this._data.core.selected.length) {
                                        ...
                                        this.trigger('changed',
                                            { 'action': 'ready', 'selected': this._data.core.selected });
                                    }
                                    /**
                ...
                .on('focus.jstree',
                    ...
                    $.proxy(function(e) {
                        ...
                        this))
                .on('mouseenter.jstree',
                    '.jstree-anchor',
                    $.proxy(function(e) {
                            this.hover_node(e.currentTarget);
                        },
                        this))
                .on('mouseleave.jstree',
                    '.jstree-anchor',
                    $.proxy(function(e) {
        ...
        get_node: function(obj, as_dom) {
            ...
            try {
                if (this._model.data[obj]) {
                    ...
                    this._model.data[dom.closest('li').attr('id')]) {
        ...
        load_node: function(obj, callback) {
            ...
            if (obj.state.loaded) {
                ...
                for (k = 0, l = obj.children_d.length; k < l; k++) {
                    for (i = 0, j = obj.parents.length; i < j; i++) {
                        this._model.data[obj.parents[i]].children_d =
                            $.vakata.array_remove_item(this._model.data[obj.parents[i]].children_d, obj.children_d[k]);
                    }
                ...
                if (c) {
                    this.trigger('changed',
                        { 'action': 'load_node', 'node': obj, 'selected': this._data.core.selected });
                }
            }
        ...
        _load_node: function(obj, callback) {
            ...
            if (!s) {
                return callback.call(this,
                    obj.id === '#'
                    ? this._append_html_data(obj, this._data.core.original_container_html.clone(true))
                    : false);
            }
            if ($.isFunction(s)) {
                return s.call(this,
        ...
        redraw_node: function(node, deep, is_callback) {
            ...
            node = this.element[0].querySelector('#' +
            ...
            if (d.length) {
                if (!animation) {
                    ...
                    d
                        ...
                        .children("ul").stop(true, true).slideUp(animation,
                            function() {
                                this.style.display = "";
        ...
        activate_node: function(obj, e) {
            ...
            this._data.core.last_clicked = this._data.core.last_clicked && this._data.core.last_clicked.id !== undefined
        ...
        select_node: function(obj, supress_event, prevent_open, e) {
            ...
            if (!obj.state.selected) {
                ...
                if (!supress_event) {
                     ...
                     */
                    this.trigger('changed',
                        { 'action': 'select_node', 'node': obj, 'selected': this._data.core.selected, 'event': e });
                }
            }
        },
        /**
        ...
        deselect_node: function(obj, supress_event, e) {
            ...
            if (obj.state.selected) {
                ...
                if (!supress_event) {
                    this.trigger('changed',
                        { 'action': 'deselect_node', 'node': obj, 'selected': this._data.core.selected, 'event': e });
                }
            }
        },
        /**
        ...
        select_all: function(supress_event) {
            ...
            if (!supress_event) {
                this.trigger('changed',
                    { 'action': 'select_all', 'selected': this._data.core.selected, 'old_selection': tmp });
            }
        },
        /**
        ...
        deselect_all: function(supress_event) {
            ...
            if (!supress_event) {
                this.trigger('changed',
                    { 'action': 'deselect_all', 'selected': this._data.core.selected, 'old_selection': tmp });
            }
        },
        /**
        ...
        get_selected: function(full) {
            return full
                ? $.map(this._data.core.selected, $.proxy(function(i) { return this.get_node(i); }, this))
                : this._data.core.selected;
        },
        /**
            ...
            this.load_node('#',
                function(o, s) {
                    if (s) {
                        ...
                        this.set_state($.extend(true, {}, this._data.core.state),
                            function() {
                                /**
        ...
        delete_node: function(obj) {
            ...
            if (c) {
                this.trigger('changed',
                    { 'action': 'delete_node', 'node': obj, 'selected': this._data.core.selected, 'parent': par.id });
            }
            for (k = 0, l = tmp.length; k < l; k++) {
        ...
        set_theme: function(theme_name, theme_url) {
            ...
            this.element[this.settings.core.themes.responsive ? 'addClass' : 'removeClass']('jstree-' +
                theme_name +
                '-responsive');
            /**
        ...
        set_icon: function(obj, icon) {
            ...
            if (icon === false) {
                ...
                dom.removeClass(old).css("background", "");
                dom.addClass('jstree-themeicon-custom').css("background", "url('" + icon + "') center center no-repeat")
                    .attr("rel", icon);
            }
            return true;
        },
    ...
    $.vakata.attributes = function(node, with_values) {
        ...
        if (node && node.attributes) {
            $.each(node.attributes,
                function(i, v) {
                    if ($.inArray(v.nodeName.toLowerCase(), ['style', 'contenteditable', 'hasfocus', 'tabindex']) !==
                        -1) {
                        return;
                    }
    ...
    $.jstree.plugins.checkbox = function(options, parent) {
        this.bind = function() {
            ...
            if (this.settings.checkbox.three_state) {
                this.element
                    .on('changed.jstree move_node.jstree copy_node.jstree redraw.jstree open_node.jstree',
                        $.proxy(function() {
                                ...
                                if (p.state.selected) {
                                    ...
                                    for (i = 0, j = dpc.length; i < j; i++) {
                                        if (m[dpc[i]].state.selected) {
                                            ...
                                            this._data.core.selected =
                                                this._data.core.selected.concat(m[dpc[i]].children_d);
                                        }
                                    }
                                }
                    ...
                    .on('select_node.jstree',
                        $.proxy(function(e, data) {
                                var obj = data.node,
                                    ...
                                    tmp;
                                this._data.core.selected =
                                    $.vakata.array_unique(this._data.core.selected.concat(obj.children_d));
                                for (i = 0, j = obj.children_d.length; i < j; i++) {
                    ...
                    .on('deselect_node.jstree',
                        $.proxy(function(e, data) {
                                ...
                                tmp = [];
                                for (i = 0, j = this._data.core.selected.length; i < j; i++) {
                                    if ($.inArray(this._data.core.selected[i], obj.children_d) === -1 &&
                                        $.inArray(this._data.core.selected[i], obj.parents) === -1) {
                                ...
                                while (p && p.id !== '#') {
                                    ...
                                    if (c === j) {
                                        ...
                                        if (p.state.selected) {
                                            ...
                                            this._data.core.selected =
                                                $.vakata.array_remove_item(this._data.core.selected, p.id);
                                            tmp = this.get_node(p, true);
                                            if (tmp && tmp.length) {
                                                tmp.children('.jstree-anchor').removeClass('jstree-clicked');
                                            }
...
// TODO: move logic outside of function + check multiple move
        ...
        items: function(o, cb) { // Could be an object directly
            return {
                ...
                "rename": {
                    ...
                    "_disabled":
                        false, //(this.check("rename_node", data.reference, this.get_parent(data.reference), "")),
                    "label": "Rename",
                    /*
                    "shortcut"			: 113,
                    "shortcut_label"	: 'F2',
                ...
                "remove": {
                    ...
                    "separator_after": false,
                    "_disabled":
                        false, //(this.check("delete_node", data.reference, this.get_parent(data.reference), "")),
                    "label": "Delete",
                    "action": function(data) {
                        var inst = $.jstree.reference(data.reference),
                            obj = inst.get_node(data.reference);
    ...
    $.jstree.plugins.contextmenu = function(options, parent) {
        this.bind = function() {
            ...
            */
            $(document).on("context_hide.vakata",
                $.proxy(function() { this._data.contextmenu.visible = false; }, this));
        };
        ...
        this._show_contextmenu = function(obj, x, y, i) {
            var d = this.get_node(obj, true),
                a = d.children(".jstree-anchor");
            $(document).one("context_show.vakata",
                $.proxy(function(e, data) {
            ...
            vakata_context.element
                ...
                .on('keydown',
                    ...
                    function(e) {
                        ...
                        case 37:
                            if (vakata_context.is_visible) {
                                vakata_context.element.find(".vakata-context-hover").last().parents("li:eq(0)")
                                    .find("ul").hide().find(".vakata-context-hover").removeClass("vakata-context-hover")
                                    .end().end().children('a').focus();
                                e.stopImmediatePropagation();
                                e.preventDefault();
                            }
                            break;
                        case 38:
                            if (vakata_context.is_visible) {
                                o = vakata_context.element.find("ul:visible").addBack().last()
                                    .children(".vakata-context-hover").removeClass("vakata-context-hover")
                                    .prevAll("li:not(.vakata-context-separator)").first();
                                if (!o.length) {
                                    o = vakata_context.element.find("ul:visible").addBack().last()
                                        .children("li:not(.vakata-context-separator)").last();
                                }
                        ...
                        case 39:
                            if (vakata_context.is_visible) {
                                vakata_context.element.find(".vakata-context-hover").last().children("ul").show()
                                    .children("li:not(.vakata-context-separator)").removeClass("vakata-context-hover")
                                    .first().addClass("vakata-context-hover").children('a').focus();
                                e.stopImmediatePropagation();
                                e.preventDefault();
                            }
                            break;
                        case 40:
                            if (vakata_context.is_visible) {
                                o = vakata_context.element.find("ul:visible").addBack().last()
                                    .children(".vakata-context-hover").removeClass("vakata-context-hover")
                                    .nextAll("li:not(.vakata-context-separator)").first();
                                if (!o.length) {
                                    o = vakata_context.element.find("ul:visible").addBack().last()
                                        .children("li:not(.vakata-context-separator)").first();
                                }
                                o.addClass("vakata-context-hover").children('a').focus();
                                e.stopImmediatePropagation();
                                e.preventDefault();
                    ...
                    $.proxy(function(e) {
                            ...
                            if (obj &&
                                ...
                                ($.isFunction(this.settings.dnd.is_draggable) &&
                                    this.settings.dnd.is_draggable.call(this,
                                        (mlt > 1 ? this.get_selected(true) : [obj]))))
                            ) {
                                ...
                                return $.vakata.dnd.start(e,
                                    {
                                        ...
                                        'origin': this,
                                        'obj': this.get_node(obj, true),
                                        'nodes': mlt > 1 ? this.get_selected() : [obj.id]
                                    },
        ...
        $(document)
                ...
                function(e, data) {
                    ...
                    if (ins && ins._data && ins._data.dnd) {
                        ...
                        data.helper
                            ...
                            .find('.jstree-copy:eq(0)')[data.data.origin &&
                                        ...
                                        for (t1 = 0, t2 = data.data.nodes.length; t1 < t2; t1++) {
                                            ...
                                            ((ins &&
                                                ...
                                                ins.check(op,
                                                    ...
                                                    p,
                                                    ps,
                                                    { 'dnd': true, 'ref': ins.get_node(ref.parent()), 'pos': v }));
                                            if (!ok) {
                ...
                function(e, data) {
                    ...
                    if (lastmv) {
                        ...
                        lastmv.ins[data.data.origin &&
                            ...
                            (data.event.metaKey || data.event.ctrlKey)
                            ? 'copy_node'
                            : 'move_node'](nodes, lastmv.par, lastmv.pos);
                    } else {
            ...
            .bind('keyup keydown',
                function(e, data) {
                    ...
                    if (data.data && data.data.jstree) {
                        data.helper.find('.jstree-copy:eq(0)')[data.data.origin &&
                            data.data.origin.settings.dnd.copy &&
                            (e.metaKey || e.ctrlKey)
                            ? 'show'
                            : 'hide']();
 ...
 */
    ...
    $.jstree.plugins.search = function(options, parent) {
        this.bind = function() {
            ...
            this.element.on('before_open.jstree',
                $.proxy(function(e, data) {
                        ...
                        if (r && r.length) {
                            ...
                            if (this.settings.search.show_only_matches && this._data.search.res.length) {
                                this.element.find("li").hide().filter('.jstree-last')
                                    .filter(function() { return this.nextSibling; }).removeClass('jstree-last');
            ...
            if (this.settings.search.show_only_matches) {
                this.element
                    .on("search.jstree",
                        function(e, data) {
                            if (data.nodes.length) {
                                $(this).find("li").hide().filter('.jstree-last')
                                    .filter(function() { return this.nextSibling; }).removeClass('jstree-last');
                    ...
                    .on("clear_search.jstree",
                        function(e, data) {
                            if (data.nodes.length) {
                                $(this).find("li").css("display", "").filter('.jstree-last')
                                    .filter(function() { return this.nextSibling; }).removeClass('jstree-last');
                            }
                        });
            }
        ...
        this.clear_search = function() {
            ...
            this.trigger('clear_search',
                { 'nodes': this._data.search.dom, str: this._data.search.str, res: this._data.search.res });
            this._data.search.str = "";
            this._data.search.res = [];
            this._data.search.opn = [];
            this._data.search.dom = $();
 ...
 */
    ...
    $.jstree.plugins.state = function(options, parent) {
        ...
        this.restore_state = function() {
            ...
            if (!!k) {
                this.element.one("set_state.jstree",
                    function(e, data) { data.instance.trigger('restore_state', { 'state': $.extend(true, {}, k) }); });
                this.set_state(k);
                return true;
            }
            return false;
            ...
            case "copy_node":
                if (chk !== 'move_node' || $.inArray(obj.id, par.children) === -1) {
                    ...
                    if (tmp.valid_children !== undefined &&
                        ...
                        $.inArray(obj.type, tmp.valid_children) === -1) {
                        this._data.core.last_error = {
                            'error': 'check',
                            'plugin': 'types',
                            'id': 'types_02',
    ...
    $.jstree.plugins.wholerow = function(options, parent) {
        this.bind = function() {
            ...
            this.element
                ...
                .on("open_node.jstree",
                    $.proxy(function(e, data) {
                            this.get_node(data.node, true).find('.jstree-clicked').parent().children('.jstree-wholerow')
                                .addClass('jstree-wholerow-clicked');
                        },
                        this))
                .on("hover_node.jstree dehover_node.jstree",
                    $.proxy(function(e, data) {
                            this.get_node(data.node, true).children('.jstree-wholerow')[e.type === "hover_node"
                                ? "addClass"
                                : "removeClass"]('jstree-wholerow-hovered');
                        },
                        this))
                .on("contextmenu.jstree",
                    ".jstree-wholerow",
