    ...
    Test.prototype = {
        ...
        setup: function() {
            ...
            try {
                ...
                QUnit.pushFailure("Setup failed on " + this.testName + ": " + (e.message || e),
        ...
        teardown: function() {
            ...
            if (config.notrycatch) {
                ...
                try {
                    ...
                    QUnit.pushFailure("Teardown failed on " + this.testName + ": " + (e.message || e),
                        extractStacktrace(e, 1));
                }
            }
            checkPollution();
        ...
        finish: function() {
            ...
            if (config.requireExpects && this.expected === null) {
                QUnit.pushFailure("Expected number of assertions to be defined, but expect() was not called.",
                    this.stack);
            ...
            */
            ...
            push: function(result, actual, expected, message) {
                ...
                if (!result) {
                    ...
                    output += "<table><tr class='test-expected'><th>Expected: </th><td><pre>" +
                        expected +
                        "</pre></td></tr>";

                    if (actual !== expected) {
                        output += "<tr class='test-actual'><th>Result: </th><td><pre>" + actual + "</pre></td></tr>";
                        output += "<tr class='test-diff'><th>Diff: </th><td><pre>" +
    ...
    QUnit.load = function() {
        ...
        if (toolbar) {
            ...
            if (numModules > 1) {
                ...
                addEvent(moduleFilter.lastChild,
                    "change",
                    function() {
