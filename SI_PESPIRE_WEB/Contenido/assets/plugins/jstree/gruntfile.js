...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            options: {
                banner:
                    '/*! <%= pkg.title || pkg.name %> - v<%= pkg.version %> - <%= grunt.template.today("yyyy-mm-dd") %> - (<%= _.pluck(pkg.licenses, "type").join(", ") %>) */\n',
    ...
    grunt.registerMultiTask('dox',
        ...
        function() {
            ...
            exec(formatter + ' < "dist/jstree.js" > "docs/jstree.json"',
                { maxBuffer: 5000 * 1024 },
    ...
    grunt.registerTask('default',
        [
            'jshint:beforeconcat', 'concat', 'amd', 'jshint:afterconcat', 'copy:libs', 'uglify', 'less', 'imagemin',
            'copy:docs', 'qunit', 'dox'
        ]);
