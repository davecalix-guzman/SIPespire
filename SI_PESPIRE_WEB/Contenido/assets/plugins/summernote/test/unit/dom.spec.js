 ...
 */
define(["jquery", "summernote/core/dom", "summernote/core/func"],
    function($, dom, func) {
        return function() {
            test("dom.ancestor",
                function() {
            ...
            test("dom.listAncestor",
                function() {
                    ...
                    deepEqual(dom.listAncestor($b[0],
                            function(node) {
                                return node === $i[0];
                            }),
                        [$b[0], $u[0], $s[0], $i[0]],
                        "listAncestor from b to i should returns [$b, $u, $s, $i]");

                    deepEqual(dom.listAncestor($u[0],
                            function(node) {
                                return node === $s[0];
                            }),
                        [$u[0], $s[0]],
                        "listAncestor from u to s should returns [$u, $s]");

                });

            test("dom.listDescendant",
                function() {
                    var $cont, $b, $u, $s, $i;
                    ...
                    deepEqual(
                        ...
                        [$b[0], $s[0]],
                        "listDescendant($cont, pred(b,s) should returns [$b, $s]"
                    );

                });

            test("dom.commonAncestor",
                function() {
            ...
            test("dom.listBetween",
                function() {
                    ...
                    deepEqual(dom.listBetween($b[0], $s[0]),
                        [
                            $b[0], $b[0].firstChild,
                            $u[0], $u[0].firstChild,
                            $s[0]
            ...
            test("dom.split",
                function() {
                    ...
                    equalsToUpperCase($cont.html(),
                        "<b>b</b><u>u</u><s>s</s><i>i</i>",
                        "splitBy i tag with offset 1 (right edge case)");
                    ...
                    equalsToUpperCase($cont.html(),
                        "<b>b</b><u>u</u><s>str</s>",
                        "splitBy s tag with offset 3 (middle case)");
                    ...
                    equalsToUpperCase($cont.html(),
                        "<b>b</b><u>u</u><s></s>",
                        "splitBy s tag with offset 0 (left edge case)");
                    ...
                    equalsToUpperCase($cont.html(),
                        "<b>b</b><u>u</u><s>strike</s>",
                        "splitBy s tag with offset 6 (right edge case)");
                    ...
                    equalsToUpperCase($cont.html(),
                        "<b>b</b><u>u</u><s>str</s><s>ike</s><i>i</i>",
                    ...
                    equalsToUpperCase($cont.html(),
                        "<span><b>b</b><u>u</u></span><span><s>s</s><i>i</i></span>",
