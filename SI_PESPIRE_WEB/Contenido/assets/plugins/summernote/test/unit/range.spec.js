 ...
 */
define(["jquery", "summernote/core/dom", "summernote/core/range"],
    function($, dom, range) {
        return function() {
            test("rng.nodes",
                function() {
            ...
            test("rng.commonAncestor",
                function() {
                    ...
                    equal(rng.commonAncestor(),
                        $span[0],
                        "rng.commonAncestor on between <b>|b</b> and <u>u|</u> should returns <span>");

                    rng = range.create($b[0].firstChild, 0, $b[0].firstChild, 1);
                    equal(rng.commonAncestor(),
                        $b[0].firstChild,
                        "rng.commonAncestor on <b>|b|</b> should returns b(#textNode)");
