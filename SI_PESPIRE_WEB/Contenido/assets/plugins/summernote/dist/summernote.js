...
(function(factory) {
    ...
    var range = (function() {
        ...
        var textRange2bp = function(textRange, isStart) {
            ...
            if (nOffset !== 0 && dom.isText(aChild[nOffset - 1])) {
                ...
                if (isStart &&
                    elCurText.nextSibling &&
                    dom.isText(elCurText.nextSibling) &&
                    nTextCount === elCurText.nodeValue.length) {
                    nTextCount -= elCurText.nodeValue.length;
                    elCurText = elCurText.nextSibling;
                }
        ...
        var WrappedRange = function(sc, so, ec, eo) {
            ...
            this.nodes = function(pred) {
                ...
                var aMatched = list.compact($.map(aNode,
                    function(node) {
    ...
    var Editor = function() {
        ...
        this.createLink = function($editable, linkInfo, options) {
            ...
            // Edit link tags
            $.each(rng.nodes(dom.isAnchor),
                function(idx, elAnchor) {
                    // link text
    ...
    var Button = function() {
        ...
        this.update = function($container, oStyle) {
            ...
            btnState('button[data-event="bold"]',
                function() {
                    return oStyle["font-bold"] === "bold";
                });
            btnState('button[data-event="italic"]',
                function() {
                    return oStyle["font-italic"] === "italic";
                });
            btnState('button[data-event="underline"]',
                function() {
                    return oStyle["font-underline"] === "underline";
                });
            btnState('button[data-event="strikethrough"]',
                function() {
                    return oStyle["font-strikethrough"] === "strikethrough";
                });
            btnState('button[data-event="superscript"]',
                function() {
                    return oStyle["font-superscript"] === "superscript";
                });
            btnState('button[data-event="subscript"]',
                function() {
                    return oStyle["font-subscript"] === "subscript";
                });
            btnState('button[data-event="justifyLeft"]',
                function() {
                    return oStyle["text-align"] === "left" || oStyle["text-align"] === "start";
                });
            btnState('button[data-event="justifyCenter"]',
                function() {
                    return oStyle["text-align"] === "center";
                });
            btnState('button[data-event="justifyRight"]',
                function() {
                    return oStyle["text-align"] === "right";
                });
            btnState('button[data-event="justifyFull"]',
                function() {
                    return oStyle["text-align"] === "justify";
                });
            btnState('button[data-event="insertUnorderedList"]',
                function() {
                    return oStyle["list-style"] === "unordered";
                });
            btnState('button[data-event="insertOrderedList"]',
                function() {
    ...
    var Dialog = function() {
        ...
        this.showHelpDialog = function($editable, $dialog) {
            return $.Deferred(function(deferred) {
                ...
                $helpDialog.one("hidden.bs.modal",
                    function() {
                        deferred.resolve();
                    }).modal("show");
            }).promise();
    ...
    var EventHandler = function() {
        ...
        this.attach = function(oLayoutInfo, options) {
            ...
            var $catcherContainer = options.airMode ? oLayoutInfo.popover : oLayoutInfo.toolbar;
    ...
    var Renderer = function() {
        ...
        var tplShortcutAction = function(lang) {
            var body = "<tr><td>⌘ + Z</td><td>" +
                ...
                "</td></tr>" +
                "<tr><td>⌘ + ]</td><td>" +
                lang.paragraph.indent +
                "</td></tr>" +
                "<tr><td>⌘ + [</td><td>" +
                lang.paragraph.outdent +
                "</td></tr>" +
                "<tr><td>⌘ + ENTER</td><td>" +
                lang.hr.insert +
                "</td></tr>";
        ...
        var tplShortcutPara = function(lang) {
            var body = "<tr><td>⌘ + ⇧ + L</td><td>" +
                lang.paragraph.left +
                "</td></tr>" +
                "<tr><td>⌘ + ⇧ + E</td><td>" +
                lang.paragraph.center +
                "</td></tr>" +
                "<tr><td>⌘ + ⇧ + R</td><td>" +
                lang.paragraph.right +
                "</td></tr>" +
                "<tr><td>⌘ + ⇧ + J</td><td>" +
                lang.paragraph.justify +
                "</td></tr>" +
                "<tr><td>⌘ + ⇧ + NUM7</td><td>" +
                lang.lists.ordered +
                "</td></tr>" +
                "<tr><td>⌘ + ⇧ + NUM8</td><td>" +
                lang.lists.unordered +
                "</td></tr>";
        ...
        var tplDialogs = function(lang, options) {
            var tplImageDialog = function() {
                ...
                var footer = '<button href="#" class="btn btn-primary note-image-btn disabled" disabled>' +
                    lang.image.insert +
                    "</button>";
            ...
            var tplLinkDialog = function() {
                ...
                var footer = '<button href="#" class="btn btn-primary note-link-btn disabled" disabled>' +
                    lang.link.insert +
                    "</button>";
            ...
            var tplVideoDialog = function() {
                var body = '<div class="form-group">' +
                    ...
                    lang.video.providers +
                    "</small>" +
                    '<input class="note-video-url form-control span12" type="text" />' +
                    "</div>";
                var footer = '<button href="#" class="btn btn-primary note-video-btn disabled" disabled>' +
                    lang.video.insert +
                    "</button>";
            ...
            var tplHelpDialog = function() {
                var body = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' +
                    lang.shortcut.close +
                    "</a>" +
                    '<div class="title">' +
            ...
            $container.find(".note-color-palette").each(function() {
                ...
                for (var row = 0, szRow = aaColor.length; row < szRow; row++) {
                    ...
                    for (var col = 0, szCol = aColor.length; col < szCol; col++) {
                        ...
                        aButton.push([
                            '<button type="button" class="note-color-btn" style="background-color:', sColor,
                            ';" data-event="', sEvent,
                            '" data-value="', sColor,
                            '" title="', sColor,
        ...
        this.createLayoutByFrame = function($holder, options) {
            ...
            if (options.height > 0) {
                $('<div class="note-statusbar">' + (options.disableResizeEditor ? "" : tplStatusbar()) + "</div>")
                    .prependTo($editor);
            }
