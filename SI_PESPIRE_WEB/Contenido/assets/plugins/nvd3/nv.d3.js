...
//  Development render timers - disabled if dev = false
    ...
    if (nv.dev) {
        nv.dispatch.on("render_start",
            function(e) {
                nv.logs.startTime = +new Date();
            });

        nv.dispatch.on("render_end",
            function(e) {
...
// causes a TypeError to be thrown.
    ...
    d3.time.monthEnds = d3_time_range(d3.time.monthEnd,
        function(date) {
...
*/
    (function() {
        ...
        */,
                ...
                ,
                snapDistance =
                    25 //Tolerance allowed before tooltip is moved from its current position (creates 'snapping' effect)
                ,
...
*/
    ...
    nv.models.axis = function() {
            ...
            selection.each(function(data) {
                ...
                case "bottom":
                    ...
                    if (staggerLabels)
                        xTicks
                            .attr("transform",
                                function(d, i) { return "translate(0," + (i % 2 == 0 ? "0" : "12") + ")" });
                ...
                case "left":
                    ...
                    */
                    ...
                    axisLabel
                        ...
                        .attr("y",
                            rotateYLabel
                            ? (-Math.max(margin.left, width) + axisLabelDistance)
                            : -10) //TODO: consider calculating this based on largest tick width... OR at least expose this on chart
                        .attr("x", rotateYLabel ? (-scale.range()[0] / 2) : -axis.tickPadding());
                    if (showMaxMin) {
                        var axisMaxMin = wrap.selectAll("g.nv-axisMaxMin")
                            ...
                            try {
                                if (i) // i== 1, max position
                                    maxMinRange.push(scale(d) -
                                        this.getBBox().width -
                                        4); //assuming the max and min labels are as wide as the next tick (with an extra 4 pixels just in case)
        ...
        d3.rebind(chart,
            ...
            "range",
            "rangeBand",
            "rangeBands"); //these are also accessible by chart.scale(), but added common ones directly for ease of use
            ...
            selection.each(function(data) {
                ...
                var barsEnter = bars.enter().append("rect")
                    ...
                    .attr("transform",
                        function(d, i) {
                            return "translate(" +
                                (x(getX(d, i)) - availableWidth / data[0].values.length * .45) +
                                ",0)";
                        })
                    .on("mouseover",
                        function(d, i) {
                ...
                bars.transition()
                    ...
                    .attr("height",
                        function(d, i) { return nv.utils.NaNtoZero(Math.max(Math.abs(y(getY(d, i)) - y(0)), 1)) });
            ...
            selection.each(function(d, i) {
                ...
                if (markerz[0]) {
                    g.selectAll("path.nv-markerTriangle")
                        .attr("transform",
                            function(d) { return "translate(" + x1(markerz[0]) + "," + (availableHeight / 2) + ")" })
...
// http://projects.instantcognition.com/protovis/bulletchart/
    nv.models.bulletChart = function() {
        ...
        function chart(selection) {
            selection.each(function(d, i) {
                ...
                var x1 = d3.scale.linear()
                    .domain([
                        0, Math.max(rangez[0], markerz[0], measurez[0])
                ...
                */
                ...
                var tick = g.selectAll("g.nv-tick")
                    .data(x1.ticks(availableWidth / 50),
                        function(d) {
        ...
        bullet.dispatch.on("elementMouseover.tooltip",
            function(e) {
                dispatch.tooltipShow(e);
            });

        bullet.dispatch.on("elementMouseout.tooltip",
            function(e) {
    ...
    nv.models.cumulativeLineChart = function() {
        ...
        var dx = d3.scale.linear(), index = { i: 0, x: 0 };
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                lines.dispatch.on("elementClick",
                    function(e) {
                ...
                controls.dispatch.on("legendClick",
                    function(d, i) {
                ...
                legend.dispatch.on("stateChange",
                    function(newState) {
                ...
                interactiveLayer.dispatch.on("elementMousemove",
                    function(e) {
                        ...
                        if (allData.length > 2) {
                            ...
                            var indexToHighlight = nv.nearestValueIndex(allData.map(function(d) { return d.value }),
                                yValue,
                                threshold);
                ...
                interactiveLayer.dispatch.on("elementMouseout",
                    function(e) {
        ...
        lines.dispatch.on("elementMouseover.tooltip",
            function(e) {
...
//TODO: consider deprecating by adding necessary features to multiBar model
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                var barsEnter = bars.enter().append("g")
                    ...
                    .on("mouseover",
                        function(d, i) { //TODO: figure out why j works above, but not here
                            d3.select(this).classed("hover", true);
                            dispatch.elementMouseover({
                                value: getY(d, i),
                                point: d,
                                ...
                                pos: [
                                    x(getX(d, i)) + (x.rangeBand() * (d.series + .5) / data.length), y(getY(d, i))
                                ], // TODO: Figure out why the value appears to be shifted
                                pointIndex: i,
    ...
    nv.models.discreteBarChart = function() {
                ...
                if (showXAxis) {
                    ...
                    if (staggerLabels) {
                        xTicks
                            .selectAll("text")
                            .attr("transform",
                                function(d, i, j) { return "translate(0," + (j % 2 == 0 ? "5" : "17") + ")" });
                    }
                }
        ...
        discretebar.dispatch.on("elementMouseover.tooltip",
            function(e) {
                e.pos = [e.pos[0] + margin.left, e.pos[1] + margin.top];
                dispatch.tooltipShow(e);
            });

        discretebar.dispatch.on("elementMouseout.tooltip",
            function(e) {
                dispatch.tooltipHide(e);
            });
    ...
    nv.models.historicalBarChart = function() {
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                legend.dispatch.on("legendClick",
                    function(d, i) {
                        d.disabled = !d.disabled;
                ...
                legend.dispatch.on("legendDblclick",
                    function(d) {
        ...
        bars.dispatch.on("elementMouseover.tooltip",
            function(e) {
                e.pos = [e.pos[0] + margin.left, e.pos[1] + margin.top];
                dispatch.tooltipShow(e);
            });
    ...
    nv.models.indentedTree = function() {
        ...
        var margin = { top: 0, right: 0, bottom: 0, left: 0 } //TODO: implement, maybe as margin on the containing div
            ...
            tableClass = null,
            iconOpen =
                "images/grey-plus.png" //TODO: consider removing this and replacing with a '+' or '-' unless user defines images
            ,
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                var node = tbody.selectAll("tr")
                    ...
                    .data(function(d) {
                            return d.filter(function(d) { return (filterZero && !d.children) ? filterZero(d) : true; })
                        },
                ...
                columns.forEach(function(column, index) {
                    ...
                    var nodeName = nodeEnter.append("td")
                        .style("padding-left",
                            function(d) { return (index ? 0 : d.depth * childIndent + 12 + (icon(d) ? 0 : 16)) + "px" },
                        ...
                        d3.select(this).select("span")
                            ...
                            .text(function(d) {
                                return column.format
                                    ? (d[column.key] ? column.format(d[column.key]) : "-")
                                    : (d[column.key] || "-");
                            });
                    });
                    ...
                    if (column.showCount) {
                        ...
                        node.selectAll("span.nv-childrenCount").text(function(d) {
                            return ((d.values && d.values.length) || (d._values && d._values.length))
                                ...
                                "(" +
                                ((d.values &&
                                    (d.values.filter(function(d) { return filterZero ? filterZero(d) : true; })
                                        .length)) //If children are in values check its children and filter
                                    ||
                                    (d._values &&
                                        d._values.filter(function(d) { return filterZero ? filterZero(d) : true; })
                                        .length) //Otherwise, do the same, but with the other name, _values...
                                    ||
                                    0) +
                                ")" //This is the catch-all in case there are no children after a filter
                ...
                node
                    ...
                    .on("click",
                        function(d) {
                            dispatch.elementClick({
                                row:
                                    this, //TODO: decide whether or not this should be consistent with scatter/line events or should be an html link (a href)
                                data: d,
                                pos: [d.x, d.y]
                            });
                        })
    ...
    nv.models.legend = function() {
        ...
        var margin = { top: 5, right: 0, bottom: 5, left: 0 },
            ...
            ,
            radioButtonMode =
                false //If true, clicking legend items will cause it to behave like a radio button. (only one can be selected at a time)
            ,
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                if (align) {
                    ...
                    if (rightAlign) {
                        g.attr("transform",
                            "translate(" + (width - margin.right - legendWidth) + "," + margin.top + ")");
                    } else {
                    ...
                    .attr("d",
                        function(d) {
                            return d3.svg.area()
                                ...
                                .y1(function(d, i) {
                                    return y(
                                        y.domain()[0] <= 0 ? y.domain()[1] >= 0 ? 0 : y.domain()[1] : y.domain()[0])
                                })
                                //.y1(function(d,i) { return y0(0) }) //assuming 0 is within y domain.. may need to tweak this
                                .apply(this, [d.values]);
                        });
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                x = dataLines.filter(function(d) { return !d.disabled; }).length &&
                    dataLines.filter(function(d) { return !d.disabled; })[0].values.length
                    ? lines.xScale()
                    : bars.xScale();
                    ...
                    .on("mouseover",
                        function(d, i) { //TODO: figure out why j works above, but not here
                            ...
                            dispatch.elementMouseover({
                                ...
                                pos: [
                                    x(getX(d, i)) +
                                    (x.rangeBand() * (stacked ? data.length / 2 : d.series + .5) / data.length),
                        ...
                        .style("fill",
                            function(d, i, j) {
                                return d3.rgb(barColor(d, i))
                                    .darker(disabled.map(function(d, i) { return i }).filter(function(d, i) {
                                        return !disabled[i]
                                    })[j]).toString();
                            })
                        .style("stroke",
    ...
    nv.models.multiBarChart = function() {
        ...
        multibar.dispatch.on("elementMouseout.tooltip",
            function(e) {
                dispatch.tooltipHide(e);
            });
        dispatch.on("tooltipHide",
    ...
    nv.models.multiBarHorizontalChart = function() {
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                var gEnter = wrap.enter().append("g").attr("class", "nvd3 nv-wrap nv-multiBarHorizontalChart")
                    .append("g");
                var g = wrap.select("g");
    ...
    nv.models.multiChart = function() {
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                var extraValue1 = dataStack1.length
                    ? dataStack1.map(function(a) { return a.values }).reduce(function(a, b) {
                        return a.map(function(aVal, i) { return { x: aVal.x, y: aVal.y + b[i].y } });
                    }).concat([{ x: 0, y: 0 }])
                    : [];
                var extraValue2 = dataStack2.length
                    ? dataStack2.map(function(a) { return a.values }).reduce(function(a, b) {
                        return a.map(function(aVal, i) { return { x: aVal.x, y: aVal.y + b[i].y } });
                    }).concat([{ x: 0, y: 0 }])
                    : [];
        ...
        lines1.dispatch.on("elementMouseover.tooltip",
            function(e) {
                e.pos = [e.pos[0] + margin.left, e.pos[1] + margin.top];
                dispatch.tooltipShow(e);
            });

        lines1.dispatch.on("elementMouseout.tooltip",
            function(e) {
                dispatch.tooltipHide(e);
            });

        lines2.dispatch.on("elementMouseover.tooltip",
            function(e) {
                e.pos = [e.pos[0] + margin.left, e.pos[1] + margin.top];
                dispatch.tooltipShow(e);
            });

        lines2.dispatch.on("elementMouseout.tooltip",
            function(e) {
                dispatch.tooltipHide(e);
            });

        bars1.dispatch.on("elementMouseover.tooltip",
            function(e) {
                e.pos = [e.pos[0] + margin.left, e.pos[1] + margin.top];
                dispatch.tooltipShow(e);
            });

        bars1.dispatch.on("elementMouseout.tooltip",
            function(e) {
                dispatch.tooltipHide(e);
            });

        bars2.dispatch.on("elementMouseover.tooltip",
            function(e) {
                e.pos = [e.pos[0] + margin.left, e.pos[1] + margin.top];
                dispatch.tooltipShow(e);
            });

        bars2.dispatch.on("elementMouseout.tooltip",
            function(e) {
                dispatch.tooltipHide(e);
            });

        stack1.dispatch.on("tooltipShow",
            function(e) {
        ...
        stack1.dispatch.on("tooltipHide",
            function(e) {
                dispatch.tooltipHide(e);
            });

        stack2.dispatch.on("tooltipShow",
            function(e) {
                //disable tooltips when value ~= 0
                //// TODO: consider removing points from voronoi that have 0 value instead of this hack
        ...
        stack2.dispatch.on("tooltipHide",
            function(e) {
                dispatch.tooltipHide(e);
            });
    ...
    nv.models.ohlcBar = function() {
        ...
        var margin = { top: 0, right: 0, bottom: 0, left: 0 },
            ...
            forceY = [],
            padData =
                false // If true, adds half a data points width to front and back, for lining up a line chart with a bar chart
            ,
            clipEdge = true,
            color = nv.utils.defaultColor(),
            xDomain,
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                var ticksEnter = ticks.enter().append("path")
                    .attr("class",
                        function(d, i, j) {
                            return (getOpen(d, i) > getClose(d, i) ? "nv-tick negative" : "nv-tick positive") +
                                " nv-tick-" +
                                j +
                                "-" +
                                i
                    ...
                    .attr("transform",
                        function(d, i) { return "translate(" + x(getX(d, i)) + "," + y(getHigh(d, i)) + ")"; })
    ...
    nv.models.pie = function() {
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                wrap.attr("transform", "translate(" + margin.left + "," + margin.top + ")");
                g.select(".nv-pie").attr("transform",
                    "translate(" + availableWidth / 2 + "," + availableHeight / 2 + ")");
                g.select(".nv-pieLabels").attr("transform",
                    "translate(" + availableWidth / 2 + "," + availableHeight / 2 + ")");
    ...
    nv.models.pieChart = function() {
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                pie.dispatch.on("elementMouseout.tooltip",
                    function(e) {
                        dispatch.tooltipHide(e);
                    });
        ...
        pie.dispatch.on("elementMouseover.tooltip",
            function(e) {
                e.pos = [e.pos[0] + margin.left, e.pos[1] + margin.top];
                dispatch.tooltipShow(e);
            });
    ...
    nv.models.scatter = function() {
        ...
        var margin = { top: 0, right: 0, bottom: 0, left: 0 },
            ...
            ,
            clipVoronoi =
                true // if true, masks each point with a circle... can turn off to slightly increase performance
            ,
        ...
        var x0,
            ...
            timeoutID,
            needsUpdate =
                false // Flag for when the points are visually updating, but the interactive layer is behind, to disable tooltips
            ;
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                var wrapEnter = wrap.enter().append("g").attr("class",
                    "nvd3 nv-wrap nv-scatter nv-chart-" + id + (singlePoint ? " nv-single-point" : ""));
                var defsEnter = wrapEnter.append("defs");
                var gEnter = wrapEnter.append("g");
                var g = wrap.select("g");
                    ...
                    var vertices = d3.merge(data.map(function(group, groupIndex) {
                            return group.values
                                ...
                                .filter(function(pointArray, pointIndex) {
                                    return pointActive(pointArray[4],
                                        pointIndex); // Issue #237.. move filter to after map, so pointIndex is correct!
                                });
                        })
                    );
        ...
        dispatch.on("elementMouseover.point",
            function(d) {
                if (interactive) chart.highlightPoint(d.seriesIndex, d.pointIndex, true);
            });

        dispatch.on("elementMouseout.point",
            function(d) {
    ...
    nv.models.scatterChart = function() {
        ...
        var showTooltip = function(e, offsetElement) {
            ...
            if (tooltipX != null)
                nv.tooltip.show([leftX, topX],
                    tooltipX(e.series.key, xVal, yVal, e, chart),
                    "n",
                    1,
                    offsetElement,
                    "x-nvtooltip");
            if (tooltipY != null)
                nv.tooltip.show([leftY, topY],
                    tooltipY(e.series.key, xVal, yVal, e, chart),
                    "e",
                    1,
                    offsetElement,
                    "y-nvtooltip");
            if (tooltip != null)
                nv.tooltip.show([left, top],
                    tooltip(e.series.key, xVal, yVal, e, chart),
                    e.value < 0 ? "n" : "s",
                    null,
                    offsetElement);
        };
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                scatter.dispatch.on("elementMouseover.tooltip",
                    function(e) {
                        d3.select(".nv-chart-" +
                                scatter.id() +
                                " .nv-series-" +
        ...
        scatter.dispatch.on("elementMouseout.tooltip",
            function(e) {
                dispatch.tooltipHide(e);
    ...
    nv.models.scatterPlusLineChart = function() {
        ...
        var margin = { top: 30, right: 20, bottom: 50, left: 75 },
            ...
            tooltipX = function(key, x, y) { return "<strong>" + x + "</strong>" },
            tooltipY = function(key, x, y) { return "<strong>" + y + "</strong>" },
            tooltip = function(key, x, y, date) { return "<h3>" + key + "</h3>" + "<p>" + date + "</p>" },
            state = {},
            defaultState = null,
            dispatch = d3.dispatch("tooltipShow", "tooltipHide", "stateChange", "changeState"),
            noData = "No Data Available.",
        ...
        var showTooltip = function(e, offsetElement) {
            ...
            if (tooltip != null)
                nv.tooltip.show([left, top],
                    tooltip(e.series.key, xVal, yVal, e.point.tooltip, e, chart),
                    e.value < 0 ? "n" : "s",
                    null,
                    offsetElement);
        };
    ...
    nv.models.sparklinePlus = function() {
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                function
                    updateValueLine() { //index is currently global (within the chart), may or may not keep it that way
                        if (paused) return;
                        ...
                        hoverValue
                            .attr("transform",
                                function(d) { return "translate(" + x(sparkline.x()(data[d], d)) + ",0)" })
                            .transition().duration(250)
                            .style("stroke-opacity", 1)
    ...
    nv.models.stackedArea = function() {
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                scatter.dispatch.on("elementMouseover.area",
                    function(e) {
                        g.select(".nv-chart-" + id + " .nv-area-" + e.seriesIndex).classed("hover", true);
                    });
                scatter.dispatch.on("elementMouseout.area",
                    function(e) {
        ...
        scatter.dispatch.on("elementClick.area",
            function(e) {
    ...
    nv.models.stackedAreaChart = function() {
        ...
        function chart(selection) {
            selection.each(function(data) {
                ...
                stacked.dispatch.on("areaClick.toggle",
                    function(e) {
        ...
        stacked.dispatch.on("tooltipShow",
            function(e) {
                //disable tooltips when value ~= 0
                //// TODO: consider removing points from voronoi that have 0 value instead of this hack
                /*
        ...
        stacked.dispatch.on("tooltipHide",
            function(e) {
                dispatch.tooltipHide(e);
            });
