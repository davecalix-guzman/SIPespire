var swfobject = function() {
    ...
    function V() {
        var a = d.getElementsByTagName("body")[0], b = d.createElement(r);
        ...
        if (c) {
            ...
            (function() {
                if (typeof c.GetVariable != i) {
                    ...
                    g &&
                    (g = g.split(" ")[1].split(","), e.pv =
                        [parseInt(g[0], 10), parseInt(g[1], 10), parseInt(g[2], 10)])
                } else if (10 > f) {
                    f++;
    ...
    function F() { return!A && z("6.0.65") && (e.win || e.mac) && !(e.wk && 312 > e.wk) }
    ...
    function G(a, b, c, f) {
        ...
        if (g) {
            ...
            e.ie &&
                (e.win && 4 != g.readyState) &&
                (f = d.createElement("div"), c += "SWFObjectNew", f.setAttribute("id",
    ...
    function J(a, b, c) {
        ...
        if (g)
            if (typeof a.id == i && (a.id = c), e.ie && e.win) {
                ...
                g.outerHTML =
                    '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + o + ">" + h + "</object>";
                C[C.length] = a.id;
                f = n(a.id)
            } else {
                j = d.createElement(r);
                ...
                for (o in b)
                    b[o] != Object.prototype[o] &&
                        "movie" != o.toLowerCase() &&
                        (a = j, h = o, k = b[o], c =
                            d.createElement("param"), c.setAttribute("name", h), c.setAttribute("value", k), a
                            .appendChild(c));
    ...
    function Q(a, b, c, f) {
        if (!e.ie || !e.mac) {
            ...
            if (g) {
                ...
                f && (K = l = null);
                if (!l || K != c)
                    f = d.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), l =
                            g.appendChild(f),
                        e.ie &&
                            (e.win && typeof d.styleSheets != i && 0 < d.styleSheets.length) &&
                            (l = d.styleSheets[d.styleSheets.length - 1]), K = c;
                e.ie && e.win
                    ? l && typeof l.addRule == r && l.addRule(a, b)
                    : l && typeof d.createTextNode != i && l.appendChild(d.createTextNode(a + " {" + b + "}"))
            }
        }
    }
    ...
    function S(a) { return null != /[\\\"<>\.;]/.exec(a) && typeof encodeURIComponent != i ? encodeURIComponent(a) : a }
    ...
    var i = "undefined",
        ...
        e = function() {
            var a = typeof d.getElementById != i && typeof d.getElementsByTagName != i && typeof d.createElement != i,
                ...
                e = [0, 0, 0],
                h = null;
            if (typeof q.plugins != i &&
                typeof q.plugins["Shockwave Flash"] ==
                r) {
                if ((h = q.plugins["Shockwave Flash"].description) &&
                    !(typeof q.mimeTypes != i && q.mimeTypes[y] && !q.mimeTypes[y].enabledPlugin))
                    T = !0, g = !1, h = h.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), e[0] =
                        parseInt(h.replace(/^(.*)\..*$/, "$1"), 10), e[1] =
                        parseInt(h.replace(/^.*\.(.*)\s.*$/, "$1"), 10), e[2] = /[a-zA-Z]/.test(h)
    ...
    (function() {
        ...
        ((typeof d.readyState != i && "complete" == d.readyState ||
            ...
            u(), s ||
        (typeof d.addEventListener != i && d.addEventListener("DOMContentLoaded", u, !1), e.ie &&
            e.win &&
            (d.attachEvent("onreadystatechange",
                function() {
                    "complete" == d.readyState && (d.detachEvent("onreadystatechange", arguments.callee), u())
                }), m == top &&
                function() {
                    if (!s) {
                        try {
            ...
            function() { s || (/loaded|complete/.test(d.readyState) ? u() : setTimeout(arguments.callee, 0)) }(), M(u)))
    })();
    (function() {
        e.ie &&
            e.win &&
    ...
    return{
        ...
        getObjectById: function(a) { if (e.w3) return E(a) },
        embedSWF: function(a, b, c, d, g, o, h, j, k, m) {
            ...
            e.w3 && !(e.wk && 312 > e.wk) && a && b && c && d && g
                ? (t(b, !1), L(function() {
                    ...
                    if (h && typeof h === r)
                        for (var q in h)
                            l.flashvars = typeof l.flashvars != i
                                ? l.flashvars + ("&" + q + "=" + h[q])
                                : q + "=" + h[q];
                    if (z(g))
                        p = J(e, l, b), e.id ==
                            b &&
                            t(b, !0), n.success = !0, n.ref = p;
                    else {
                        if (o && F()) {
                            e.data = o;
                            G(e, l, b, m);
        ...
        createSWF: function(a, b, c) { if (e.w3) return J(a, b, c) },
        ...
        expressInstallCallback: function() {
            if (A) {
                ...
                a &&
                    w &&
                    (a.parentNode.replaceChild(w, a), B && (t(B, !0), e.ie && e.win && (w.style.display = "block")),
                        H && H(N));
                A = !1
            }
        }
