...
(function() {
    var r = function(c, j) {
            ...
            if (!s) {
                ...
                if (d) {
                    ...
                    for (var a = [].concat(a), e = a.length, c, g = 0; g < e; g++)
                        (c = b.getContentElement.apply(b, a[g].split(":"))) && c.setup(f, d)
                }
                s = 0
            }
        }
        ...
        var f = 1,
            ...
            w = function() {
                ...
                d && ("%" == d[2] && l(b, !1), a = d[1]);
                b.lockRatio &&
                (d = b.originalElement, "true" == d.getCustomData("isReady") &&
                ("txtHeight" == this.id
                    ? (a && "0" != a && (a = Math.round(d.$.width * (a / d.$.height))),
                        isNaN(a) || b.setValueOf("info", "txtWidth", a))
                    : (a && "0" != a && (a = Math.round(d.$.height * (a / d.$.width))), isNaN(a) ||
            ...
            l = function(a,
                ...
                if ("check" == b) {
                    if (!a.userlockRatio && "true" == d.getCustomData("isReady")) {
                        ...
                        !e && !c
                            ? a.lockRatio = !0
                            : !isNaN(d) && !isNaN(f) && Math.round(d) == Math.round(f) && (a.lockRatio = !0)
                    }
                ...
                CKEDITOR.env.hc &&
                    e.getChild(0).setHtml(a.lockRatio ? CKEDITOR.env.ie ? "■" : "▣" : CKEDITOR.env.ie ? "□" : "▢");
                return a.lockRatio
            },
            x = function(a) {
            ...
            q = function() {
                ...
                this.firstLoad &&
                    CKEDITOR.tools.setTimeout(function() { l(this, "check") },
                        0,
                        this);
            ...
            n = function(a) { return CKEDITOR.tools.getNextId() + "_" + a },
            p = n("btnLockSizes"),
            u = n("btnResetSize"),
        ...
        return{
            ...
            onShow: function() {
                ...
                if (d) {
                    ...
                    if (1 == c.count()) {
                        ...
                        if ("img" == g || "input" == g)
                            this.imageElement = c.getItem(0), "img" == this.imageElement.getName()
                                ? this.imageEditMode = "img"
                                : "input" == this.imageElement.getName() && (this.imageEditMode = "input")
                    }
                    "image" == j &&
                        this.setupContent(2, d)
                }
                if (b && "img" == b.getName() && !b.data("cke-realelement") ||
                    b && "input" == b.getName() && "image" == b.getAttribute("type"))
                    this.imageEditMode = b.getName(), this.imageElement = b;
                this.imageEditMode
                    ? (this.cleanImageElement = this.imageElement, this.imageElement =
                        this.cleanImageElement.clone(!0, !0), this.setupContent(f, this.imageElement))
                    : this.imageElement = a.document.createElement("img");
                l(this, !0);
                CKEDITOR.tools.trim(this.getValueOf("info", "txtUrl")) ||
                (this.preview.removeAttribute("src"), this.preview.setStyle("display",
                    "none"))
            },
            onOk: function() {
                if (this.imageEditMode) {
                    var a = this.imageEditMode;
                    "image" == j && "input" == a && confirm(c.lang.image.button2Img)
                        ? (this.imageElement =
                                c.document.createElement("img"), this.imageElement.setAttribute("alt", ""),
                            c.insertElement(this.imageElement))
                        : "image" != j && "img" == a && confirm(c.lang.image.img2Button)
                        ? (this.imageElement =
                    ...
                    "image" ==
                        j
                        ? this.imageElement = c.document.createElement("img")
                        : (this.imageElement =
                            c.document.createElement("input"), this.imageElement.setAttribute("type", "image")), this
                ...
                this.imageEditMode
                    ...
                    ? (c.insertElement(this.linkElement),
                        this.imageElement.appendTo(this.linkElement))
                    : this.linkEditMode &&
                    !this.addLink &&
                    (c.getSelection().selectElement(this.linkElement), c.insertElement(this.imageElement))
                    : this.addLink
                    ? this.linkEditMode
                    ? c.insertElement(this.imageElement)
            ...
            onHide: function() {
                ...
                (this.originalElement.removeListener("load", q), this.originalElement.removeListener("error", h),
                    this.originalElement.removeListener("abort", h), this.originalElement.remove(),
            ...
            contents: [
                {
                    ...
                    elements: [
                                    ...
                                    children: [
                                        {
                                            ...
                                            onChange: function() {
                                                ...
                                                if (0 < b.length) {
                                                    ...
                                                    a.preview &&
                                                    (a.preview.removeAttribute("src"), a.preview.setStyle("display",
                                                        "none"))
                                            },
                                            setup: function(a, b) {
                                                if (a == f) {
                                            ...
                                            commit: function(a, b) {
                                                a == f && (this.getValue() || this.isChanged())
                                                    ? (b.data("cke-saved-src", this.getValue()), b.setAttribute("src",
                                                        this.getValue()))
                        ...
                        },
                        {
                            ...
                            commit: function(a, b) {
                                a == f
                                    ? (this.getValue() || this.isChanged()) && b.setAttribute("alt", this.getValue())
                                    : 4 == a
                                            ...
                                            children: [
                                                {
                                                            ...
                                                            commit: function(a, b, d) {
                                                                ...
                                                                a == f
                                                                    ? (c
                                                                            ...
                                                                            : b.removeStyle("width"),
                                                                        !d && b.removeAttribute("width"))
                                                                    : 4 == a
                                                                    ? c.match(k)
                                                                    ? b.setStyle("width", CKEDITOR.tools.cssLength(c))
                                                                    : (a =
                                                                        this.getDialog().originalElement, "true" ==
                                                                        a.getCustomData("isReady") &&
                                                                        b.setStyle("width", a.$.width + "px"))
                                                                    : 8 == a &&
                                                            ...
                                                            commit: function(a, b, d) {
                                                                ...
                                                                a == f
                                                                    ...
                                                                    : (a =
                                                                        this.getDialog().originalElement, "true" ==
                                                                        a.getCustomData("isReady") &&
                                                                        b.setStyle("height", a.$.height + "px"))
                                                                    : 8 == a &&
                                                                    (b.removeAttribute("height"), b.removeStyle(
                                                                        "height"))
                                                            }
                                                        }
                                                    ]
                                                    ...
                                                    onLoad: function() {
                                                        ...
                                                        (a.on("click",
                                                            ...
                                                            function() { this.addClass("cke_btn_over") },
                                                            a), a.on("mouseout",
                                                            function() { this.removeClass("cke_btn_over") },
                                                            a));
                                                        b &&
                                                        (b.on("click",
                                                            function(a) {
                                            ...
                                            children: [
                                                {
                                                    ...
                                                    "default": "",
                                                    onKeyUp: function() { g(this.getDialog()) },
                                                    onChange: function() { i.call(this, "advanced:txtdlgGenStyle") },
                                                    validate: CKEDITOR.dialog.validate.integer(c.lang.image
                                                        .validateBorder),
                                                    setup: function(a, b) {
                                                        if (a == f) {
                                                            var d;
                                                            d =
                                                                (d = (d = b.getStyle("border-width")) &&
                                                                    d.match(/^(\d+px)(?: \1 \1 \1)?$/)) &&
                                                                parseInt(d[1], 10);
                                                    ...
                                                    commit: function(a, b, d) {
                                                        ...
                                                        a == f || 4 == a
                                                            ? (isNaN(c)
                                                                ...
                                                                : (b.setStyle("border-width",
                                                                    CKEDITOR.tools.cssLength(c)), b.setStyle(
                                                                    "border-style",
                                                                    "solid")), !d &&
                                                                a == f &&
                                                                b.removeAttribute("border"))
                                                            : 8 == a &&
                                                            (b.removeAttribute("border"), b.removeStyle("border-width"),
                                                    ...
                                                    commit: function(a, b, c) {
                                                        ...
                                                        a == f || 4 == a
                                                            ? (isNaN(e)
                                                                ? !e &&
                                                                this.isChanged() &&
                                                                (b.removeStyle("margin-left"), b.removeStyle(
                                                                    "margin-right"))
                                                                : (b.setStyle("margin-left",
                                                                    CKEDITOR.tools.cssLength(e)), b.setStyle(
                                                                    "margin-right",
                                                                    CKEDITOR.tools.cssLength(e))), !c &&
                                                                a == f &&
                                                                b.removeAttribute("hspace"))
                                                            : 8 == a &&
                                                            (b.removeAttribute("hspace"), b.removeStyle("margin-left"),
                                                    ...
                                                    commit: function(a, b, c) {
                                                        ...
                                                        a == f || 4 == a
                                                            ? (isNaN(e)
                                                                ? !e &&
                                                                this.isChanged() &&
                                                                (b.removeStyle("margin-top"), b.removeStyle(
                                                                    "margin-bottom"))
                                                                : (b.setStyle("margin-top",
                                                                    CKEDITOR.tools.cssLength(e)), b.setStyle(
                                                                    "margin-bottom",
                                                                    CKEDITOR.tools.cssLength(e))), !c &&
                                                                a == f &&
                                                            ...
                                                            : 8 == a &&
                                                            (b.removeAttribute("vspace"), b.removeStyle("margin-top"), b
                                                    ...
                                                    "default": "",
                                                    items: [
                                                        [c.lang.common.notSet, ""], [c.lang.common.alignLeft, "left"],
                                                    ...
                                                    commit: function(a, b, c) {
                                                        var e = this.getValue();
                                                        if (a == f || 4 == a) {
                                                            if (e ? b.setStyle("float", e) : b.removeStyle("float"), !
                                                                c &&
                                                                a == f)
                                                                switch (e =
                                                                    (b.getAttribute("align") || "").toLowerCase(), e) {
                                                                case "left":
                                                                case "right":
                    ...
                    elements: [
                        ...
                        },
                        {
                            ...
                            "default": "",
                            items: [
                                [c.lang.common.notSet, ""], [c.lang.common.targetNew, "_blank"],
                                [c.lang.common.targetTop, "_top"], [c.lang.common.targetSelf, "_self"],
                                [c.lang.common.targetParent, "_parent"]
                            ],
                            setup: function(a, b) {
                                2 == a &&
                                    this.setValue(b.getAttribute("target") ||
                                        "")
                            },
                            commit: function(a, b) {
                                2 == a &&
                            ...
                            children: [
                                {
                                    ...
                                    setup: function(a, b) { a == f && this.setValue(b.getAttribute("id")) },
                                    commit: function(a, b) {
                                        a == f &&
                                            (this.getValue() || this.isChanged()) &&
                                    ...
                                    "default": "",
                                    items: [
                                        [c.lang.common.notSet, ""], [c.lang.common.langDirLtr, "ltr"],
                                        [c.lang.common.langDirRtl, "rtl"]
                                    ],
                                    setup: function(a, b) { a == f && this.setValue(b.getAttribute("dir")) },
                                    commit: function(a, b) {
                                        a == f &&
                                            (this.getValue() || this.isChanged()) &&
                                ...
                                },
                                {
                                    ...
                                    "default": "",
                                    setup: function(a, b) { a == f && this.setValue(b.getAttribute("lang")) },
                                    commit: function(a, b) {
                                        a == f &&
                                            (this.getValue() || this.isChanged()) &&
    ...
    CKEDITOR.dialog.add("image", function(c) { return r(c, "image") });
    CKEDITOR.dialog.add("imagebutton", function(c) { return r(c, "imagebutton") })
})();