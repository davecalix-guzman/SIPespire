...
(function() {
    ...
    var f = function() {
            var a = function(a, b, e) {
                ...
                var b = encodeURIComponent(b), a = a + "=" + b, f;
            ...
            return{
                postMessage: {
                    ...
                    send: function(a) {
                        var b = a.fn || null, e = a.id || "", g = a.target || window, h = a.message || { id: e };
                ...
                cookie: {
                    set: a,
                    get: function(a) {
                        return(a = document.cookie.match(RegExp("(?:^|; )" +
                                a.replace(/([\.$?*|{}\(\)\[\]\\\/\+^])/g, "\\$1") +
                                "=([^;]*)")))
    ...
    var s = function(b) { for (var c in b) b[c].instance.getElement().setText(a.LocalizationComing[c]) },
        t = function(b) {
            for (var c in b) {
    ...
    a.sendData = function(b) {
        var c = b._.currentTabId, d = b._.contents[c].Content, e, g;
        a.setIframe(d, c);
        b.parts.tabs.removeAllListeners();
        b.parts.tabs.on("click",
            function(h) {
                h = h || window.event;
                h.data.getTarget().is("a") &&
                    c != b._.currentTabId &&
                    (c = b._.currentTabId, d = b._.contents[c].Content, e =
                        a.iframeNumber + "_" + c, a.div_overlay.setEnable(), d.getElement().getChildCount()
                        ? o(a.targetFromFrame[e], a.cmd[c])
                        : (a.setIframe(d, c), g = document.getElementById(e), a.targetFromFrame[e] =
                            g.contentWindow))
            })
    };
    a.buildSelectLang = function() {
        var b = new CKEDITOR.dom.element("div"), c = new CKEDITOR.dom.element("select"), d = "wscLang" + a.CKNumber;
    ...
    a.buildOptionLang = function(b) {
        var c = document.getElementById("wscLang" +
                a.CKNumber),
        ...
        if (0 === c.options.length) {
            ...
            for (var h = 0; h < g.length; h++)
                b = document.createElement("option"), b.setAttribute("value", g[h][1]), e =
                    document.createTextNode(g[h][0]), b.appendChild(e), g[h][1] == a.selectingLang &&
                    b.setAttribute("selected", "selected"), d.appendChild(b);
            c.appendChild(d)
        }
    };
    ...
    var l = function(a) {
            ...
            h || d.appendChild(f);
            return{
                setDisable: function() { f.style.display = "none" },
                setEnable: function() { f.style.display = "block" }
            }
        },
        u = function(b, c, d) {
            ...
            g.setAttributes({ type: "radio", value: c, name: "wscGrammerSuggest", id: f });
            g.setStyles({ "float": "left" });
            g.on("click", function(b) { a.textNode.GrammTab.setValue(b.sender.getValue()) });
        ...
        v = function(b) {
            if ("no_any_suggestions" == b) {
                ...
                a.LocalizationButton.ChangeTo.instance.enable(), a.LocalizationButton.ChangeAll.instance.enable(), a
                    .LocalizationButton.ChangeTo.instance.getElement()
                    .setStyle("color", "#333"), a.LocalizationButton.ChangeAll.instance.getElement()
                    .setStyle("color", "#333");
            return b
        },
        w = {
            ...
            ReplaceText: function(b) {
                ...
                window.setTimeout(function() { a.div_overlay.setDisable() }, 500);
                s(a.LocalizationButton);
                t(a.LocalizationLabel)
            },
            options_checkbox_send: function(b) {
                delete b.id;
                b = { osp: f.cookie.get("osp"), udn: f.cookie.get("udn"), cust_dic_ids: a.cust_dic_ids };
                f.postMessage.send({
                    message: b,
            ...
            options_dic_send: function() {
                ...
                f.postMessage.send(
                    { message: b, target: a.targetFromFrame[a.iframeNumber + "_" + a.dialog._.currentTabId] })
            },
            data: function(a) { delete a.id },
            giveOptions: function() {},
            setOptionsConfirmF: function() {},
            setOptionsConfirmT: function() { j.setValue("") },
            clickBusy: function() { a.div_overlay.setEnable() },
            suggestAllCame: function() {
                a.div_overlay.setDisable();
                a.div_overlay_no_check.setDisable()
            },
            TextCorrect: function() { q(a.langList) }
        },
        x = function(a) {
            a = a || window.event;
        ...
        n = function() { a.dialog.hidePage("GrammTab") },
        i = function() {
            a.dialog.getContentElement(a.dialog._.currentTabId,
                "bottomGroup").getElement().show()
        },
        m = function() {
    ...
    CKEDITOR.dialog.add("checkspell",
        function(b) {
            var c = function() {
                    a.div_overlay.setEnable();
                    var c = a.dialog._.currentTabId, d = a.iframeNumber + "_" + c, e = a.textNode[c].getValue();
                    f.postMessage.send({
                        message: { cmd: this.getElement().getAttribute("title-cmd"), tabId: c, new_word: e },
                        target: a.targetFromFrame[d],
                        id: "cmd_outer__page"
                    });
                ...
                d = "file:" == document.location.protocol ? "http:" : document.location.protocol,
                e = CKEDITOR.config.wsc_customLoaderScript ||
                    d +
                ...
                contents: [
                    {
                        ...
                        elements: [
                            { type: "html", id: "banner", label: "banner", style: "", html: "<div></div>" }, {
                                                ...
                                                children: [
                                                    {
                                                        ...
                                                        children: [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                items: [["loading..."]],
                                                                onShow: function() { k = this },
                                                                onHide: function() { this.clear() },
                                                                onChange: function() {
                                ...
                                style: "width:560px; margin: 0 auto;",
                                widths: ["70%", "30%"],
                                onShow: function() { this.getElement().hide() },
                                onHide: i,
                                children: [
                                    {
                                        type: "hbox",
                                        ...
                                        children: [
                                            {
                                                ...
                                                children: [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        onShow: function() { a.textNodeInfo.GrammTab = this }
                                                    }, {
                                                        type: "html",
                                                        id: "radio",
                                                        html: "",
                                                        ...
                                                        children: [
                                                            {
                                                                ...
                                                                labelStyle: "font: 12px/25px arial, sans-serif;",
                                                                "default": "",
                                                                onShow: function() { a.textNode.Thesaurus = this },
                                                                onHide: function() { this.reset() }
                                                            }, {
                                                                type: "button",
                                                                id: "ChangeTo",
                                                        ...
                                                        children: [
                                                            {
                                                                ...
                                                                items: [],
                                                                onShow: function() { a.selectNode.categories = this },
                                                                onHide: function() { this.clear() },
                                                                onChange: function() {
    ...
    CKEDITOR.dialog.add("options",
        function() {
            ...
            var h = function() {
                    ...
                    "delete" != g && (a = "", "" !== j.getValue() && (a = j.getValue()), f.cookie.set("udn", a));
            ...
            return{
                                                ...
                                                children: [
                                                    {
                                                        ...
                                                        onLoad: function() {
                                                            j = this;
                                                            this.setValue(a.userDictionaryName
                                                                ? a.userDictionaryName
                                                                : (f.cookie.get("udn"), this.getValue()))
                                                        },
                                                        onShow: function() {
                                                            j = this;
                                                            this.setValue(!f.cookie.get("udn")
                                                                ? this.getValue()
                                                                : f.cookie.get("udn"));
                ...
                onShow: function() {
                    ...
                    !parseInt(d.IgnoreMixedCaseWords, 10)
                        ...
                        : c.IgnoreMixedCaseWords.setValue("checked",
                            !1);
    ...
    CKEDITOR.on("dialogDefinition",
        function(b) {
            ...
            a.onLoadOverlay = new l({ opacity: "1", background: "#fff", target: c.dialog.parts.tabs.getParent().$ });
