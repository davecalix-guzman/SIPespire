        ...
        legend: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { name: "Refaire", legend: "Appuyer sur ${redo}" }, { name: "Gras", legend: "Appuyer sur ${bold}" },
                    ...
                    { name: "Enrouler la barre d'outils", legend: "Appuyer sur ${toolbarCollapse}" },
                    {
                        ...
                        legend:
                            "Appuyer ${accessPreviousSpace} pour accéder au prochain espace disponible Omega le curseur, par exemple: deux éléments HR adjacents.  Répéter la combinaison pour joindre les éléments d'espaces distantes."
                    },
                    {
