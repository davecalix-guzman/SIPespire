            ...
            },
            {
                ...
                items: [
                    ...
                    { name: " Commande enrouler la barre d'outils", legend: "Appuyer sur ${toolbarCollapse}" }, {
                        ...
                        legend:
                            "Appuyez sur ${accessPreviousSpace} pour accéder à l'espace hors d'atteinte le plus proche Omega le caret, par exemple: deux éléments HR adjacents. Répétez la combinaison de touches pour atteindre les espaces de mise au point distants."
                    },
                    {
