    ...
    function(j) {
        ...
        function x(b, a) {
            if (b) {
                ...
                else for (var d = 0; d < e; d++) b[d].checked = !1, b[d].value == a.toString() && (b[d].checked = !0)
            }
        }

        function n(b) { f.getById("dic_message_" + a).setHtml('<span style="color:red;">' + b + "</span>") }

        function o(b) { f.getById("dic_message_" + a).setHtml('<span style="color:blue;">' + b + "</span>") }
        ...
        function r(b) { f.getById("dic_name_" + a).$.value = b }
            ...
            B = {
                ...
                onShow: function() {
                    ...
                    if (!b.data || !b.data.scayt || !b.data.scayt_control)
                        ...
                        var a = 0;
                        s
                            ? b.data.scayt.getCaption(j.langCode || "en",
                                function(e) {
                                    0 < a++ ||
                                    (h = e, A.apply(b),
                                        y.apply(b), s = !1)
                ...
                onCancel: function() {
                    ...
                    b = "undefined" != typeof document.forms["languagesbar_" + a]
        ...
        var A = function() {
                ...
                if (1 ==
                    l[0])
                    for (c in v)
                        d = "label_" + v[c], g = f.getById(d + "_" + a), "undefined" != typeof g &&
                            ("undefined" != typeof h[d] && "undefined" != typeof k.options[v[c]]) &&
                ...
                var j = {
                    dic_create: function(a, b, c) {
                        ...
                        window.scayt.createUserDictionary(b,
                            function(a) {
                                q(d);
                                p(c[1]);
                ...
                j.dic_restore = k.dic_restore ||
                    function(a, b, c) {
                        var d = c[0] + "," + c[1], e = h.err_dic_restore, f = h.succ_dic_restore;
                        window.scayt.restoreUserDictionary(b,
                            function(a) {
                                f =
                                    f.replace("%s", a.dname);
                                q(d);
                ...
                if (1 == l[0])
                    for (var g = w(), e = 0, d = g.length; e < d; e++) {
                        ...
                        if (i && (g[e].checked = !1, 1 == b.options[h.split("_")[0]] && (g[e].checked = !0), s))
                            i.on("click", function() { b.options[this.getId().split("_")[0]] = this.$.checked ? 1 : 0 })
                    }
                1 == l[1] && (g = f.getById("cke_option" + b.sLang), x(g.$, b.sLang));
                u &&
                (window.scayt.getNameUserDictionary(function(b) {
                        b = b.dname;
                        q(m[0] + "," + m[1]);
                        if (b) {
                    ...
                    function() { f.getById("dic_name_" + a).setValue("") }), o(""))
            };
        return B
    });