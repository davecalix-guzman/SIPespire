    ...
    function(n) {
        ...
        function t(a) {
            ...
            for (var b = 0; b < c.length; b++)
                d = c[b].toLowerCase(), e =
                    a[d], 0 < b && g.push(","), g.push("'", e ? r(encodeURIComponent(a[d])) : "", "'");
            g.push(")");
            return g.join("")
        }
        ...
        function v(a) {
            return(a = a.getAttribute("class"))
                ? a.replace(/\s*(?:cke_anchor_empty|cke_anchor)(?:\s*$)?/g,
                    "")
                : ""
        }
            ...
            I = function(a, g) {
                ...
                ("encode" == o
                    ? c = c.replace(E,
                        function(a, c, b) {
                            return"mailto:" +
                                String.fromCharCode.apply(String, c.split(",")) +
                                (b && b.replace(/\\'/g, "'"))
                        })
                    : o &&
                    c.replace(F,
                        function(a, c, d) {
                            if (c == q) {
                                ...
                                for (var a = b.email = {},
                                    ...
                                    h < e;
                                    h++)
                                    g = decodeURIComponent, f = d[h].replace(c, "").replace(/\\'/g, "'"), f = g(f), g =
                                        p[h].toLowerCase(), a[g] = f;
                ...
                if (!b.type)
                    if (d = c.match(B))
                        ...
                        c && (e = c.match(C))
                            ? (b.type = "url", b.url = {}, b.url.protocol = e[1], b.url.url = e[2])
                            : b.type = "url";
                if (g) {
                    ...
                    b.adv = {};
                    if (d)
                        d.match(D) ? b.target.type = b.target.name = d : (b.target.type = "frame", b.target.name = d);
                    else if (d = (d = g.data("cke-pa-onclick") || g.getAttribute("onclick")) && d.match(G)) {
                        b.target.type =
                            "popup";
                        for (b.target.name = d[1]; c = H.exec(d[2]);)
                            ("yes" == c[2] || "1" == c[2]) && !(c[1] in { height: 1, width: 1, top: 1, left: 1 })
                                ? b.target[c[1]] = !0
                                : isFinite(c[2]) && (b.target[c[1]] = c[2])
                    }
                    d = function(a, c) {
                    ...
                    CKEDITOR.plugins.link.synAnchorSelector ? b.adv.advCSSClasses = v(g) : d("advCSSClasses", "class");
                ...
                if (CKEDITOR.plugins.link.emptyAnchorFix) {
                    ...
                    c = 0;
                    for (e = f.count(); c < e; c++)
                        if (h = f.getItem(c), h.data("cke-saved-name") || h.hasAttribute("name"))
                            d.push({
                ...
                if (CKEDITOR.plugins.link.fakeAnchor) {
                    ...
                    c = 0;
                    for (e = f.count(); c < e; c++)
                        (h = CKEDITOR.plugins.link.tryRestoreFakeAnchor(a, f.getItem(c))) &&
                            d.push({ name: h.getAttribute("name"), id: h.getAttribute("id") })
                }
                this._.selectedElement = g;
                return b
            },
            j = function(a) { a.target && this.setValue(a.target[this.id] || "") },
            k = function(a) { a.adv && this.setValue(a.adv[this.id] || "") },
            l = function(a) {
                a.target || (a.target = {});
        ...
        o &&
            "encode" != o &&
            (q = p = void 0, o.replace(/^([^(]+)\(([^)]+)\)$/,
                function(a, b, c) {
                    q = b;
                    p = [];
                    c.replace(/[^,\s]+/g, function(a) { p.push(a) })
                }));
        ...
        return{
                                    ...
                                    children: [
                                        {
                                            ...
                                            validate: function() {
                                                var a = this.getDialog();
                                                if (a.getContentElement("info", "linkType") &&
                                                    a.getValueOf("info", "linkType") != "url") return true;
                            ...
                            children: [
                                {
                                    ...
                                    validate: function() {
                                        ...
                                        return!a.getContentElement("info", "linkType") ||
                                            a.getValueOf("info", "linkType") != "email"
                                            ? true
                            ...
                            children: [
                                {
                                    ...
                                    style: "width : 100%;",
                                    items: [
                                        [i.notSet, "notSet"], [b.targetFrame, "frame"], [b.targetPopup, "popup"],
                                        [i.targetNew, "_blank"], [i.targetTop, "_top"], [i.targetSelf, "_self"],
                                ...
                                },
                                {
                                    ...
                                    children: [
                                        ...
                                        },
                                        {
                                            ...
                                            "default": "",
                                            id: "advStyles",
                                            validate: CKEDITOR.dialog.validate.inlineStyle(n.lang.common
                                                .invalidInlineStyle),
                                            setup: k,
                                            commit: m
                                        }
            ...
            onOk: function() {
                ...
                if (c.target)
                    if (c.target.type == "popup") {
                        for (var e = ["window.open(this.href, '", c.target.name || "", "', '"],
                            j = [
                                "resizable", "status", "location", "toolbar", "menubar", "fullscreen", "scrollbars",
                                "dependent"
                            ],
                            i = j.length,
                            f = function(a) { c.target[a] && j.push(a + "=" + c.target[a]) },
                            h = 0;
                            h < i;
                            h++) j[h] = j[h] + (c.target[j[h]] ? "=yes" : "=no");
                        f("width");
                        f("left");
                        f("height");
                        f("top");
                ...
                if (c.adv) {
                    ...
                    c.adv.advName
                        ? a.name = a["data-cke-saved-name"] = c.adv.advName
                        : b = b.concat(["data-cke-saved-name", "name"]);
                    e("advLangCode", "lang");
                ...
                if (this._.selectedElement) {
                    ...
                    c.adv &&
                        (c.adv.advName && CKEDITOR.plugins.link.synAnchorSelector) &&
                        d.addClass(d.getChildCount() ? "cke_anchor" : "cke_anchor_empty");
                    ...
                    if (e.collapsed) {
                        d =
                            new CKEDITOR.dom.text(c.type == "email" ? c.email.address : a["data-cke-saved-href"],
                                d.document);
                        e.insertNode(d);
