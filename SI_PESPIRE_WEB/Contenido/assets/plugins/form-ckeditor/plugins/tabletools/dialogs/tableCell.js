...
CKEDITOR.dialog.add("cellProperties",
    function(f) {
        ...
        return{
                            ...
                            children: [
                                {
                                    ...
                                    children: [
                                            ...
                                            children: [
                                                {
                                                    ...
                                                    onLoad: function() {
                                                        var a = this.getDialog().getContentElement("info", "widthType")
                                                                .getElement(),
                                        ...
                                        e, {
                                            ...
                                            "default": "",
                                            items: [
                                                [d.notSet, ""], [d.alignLeft, "left"], [d.alignCenter, "center"],
                                                [d.alignRight, "right"]
                                            ],
                                            setup: function(a) {
                                            ...
                                            "default": "",
                                            items: [
                                                [d.notSet, ""], [d.alignTop, "top"], [d.alignMiddle, "middle"], [
                                                    d.alignBottom,
                                                    "bottom"
                                    ...
                                    children: [
                                        {
                                            ...
                                            setup: function(a) { this.setValue(a.getName()) },
                                            commit: function(a) { a.renameNode(this.getValue()) }
                                        }, e, {
                                            type: "text",
                                            id: "rowSpan",
                                            label: c.rowSpan,
            ...
            onOk: function() {
                for (var a = this._.editor.getSelection(), b = a.createBookmarks(), c = this.cells, d = 0;
                    d < c.length;
                    d++) this.commitContent(c[d]);
