...
CKEDITOR.lang['eu'] = {
    ...
    "common":
    {
        ...
        "invalidCssLength":
            "\"%1\" eremurako zehaztutako balioa zenbaki positibo bat izan behar du, aukeran CSS neurri unitate batekin (px, %, in, cm, mm, em, ex, pt edo pc).",
        "invalidHtmlLength":
            "\"%1\" eremurako zehaztutako balioa zenbaki positibo bat izan behar du, aukeran HTML neurri unitate batekin (px edo %).",
        "invalidInlineStyle":
            "Lerroko estiloan zehazten dena tupla \"name : value\" formatuko eta puntu eta komaz bereiztutako tupla bat edo gehiago izan behar dira.",
        "cssLengthTooltip":
            "Zenbakia bakarrik zehazten bada pixeletan egongo da. CSS neurri unitatea ere zehaztu ahal da (px, %, in, cm, mm, em, ex, pt, edo pc).",
    ...
    "contextmenu": { "options": "Testuingurko Menuaren Aukerak" },
    "toolbar":
    {
    ...
    "elementspath": { "eleLabel": "Elementu bidea", "eleTitle": "%1 elementua" },
    ...
    "pastetext": { "button": "Testu Arrunta bezala Itsatsi", "title": "Testu Arrunta bezala Itsatsi" },
    "pastefromword":
    {
        "confirmCleanup":
    ...
    "sourcearea": { "toolbar": "HTML Iturburua" },
    "specialchar":
    {
