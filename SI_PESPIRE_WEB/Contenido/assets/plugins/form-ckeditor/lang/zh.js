...
CKEDITOR.lang['zh'] = {
    ...
    "basicstyles":
        { "bold": "粗體", "italic": "斜體", "strike": "刪除線", "subscript": "下標", "superscript": "上標", "underline": "底線" },
    "blockquote": { "toolbar": "引用文字" },
    "clipboard":
    {
        "copy": "複製",
    ...
    "elementspath": { "eleLabel": "Elements path", "eleTitle": "%1 元素" },
    "list": { "bulletedlist": "項目清單", "numberedlist": "編號清單" },
    ...
    "fakeobjects":
        { "anchor": "錨點", "flash": "Flash 動畫", "hiddenfield": "隱藏欄位", "iframe": "IFrame", "unknown": "不明物件" },
    "link":
    {
        "acccessKey": "存取鍵",
        "advanced": "進階",
    ...
    "pastetext": { "button": "貼為純文字格式", "title": "貼為純文字格式" },
    "pastefromword":
    {
    ...
    "specialchar": { "options": "Special Character Options", "title": "請選擇特殊符號", "toolbar": "插入特殊符號" },
    "scayt":
    {
        "about": "關於即時拼寫檢查",
        "aboutTab": "關於",
    ...
    "table": {
        ...
        "cellPad": "內距",
        "cellSpace": "間距",
        "column": { "menu": "欄", "insertBefore": "向左插入欄", "insertAfter": "向右插入欄", "deleteColumn": "刪除欄" },
        "columns": "欄數",
        "deleteTable": "刪除表格",
        "headers": "標題",
        "headersBoth": "第一欄和第一列",
        ...
        "menu": "表格屬性",
        "row": { "menu": "列", "insertBefore": "向上插入列", "insertAfter": "向下插入列", "deleteRow": "刪除列" },
        "rows": "列數",
        "summary": "摘要",
        "title": "表格屬性",
        "toolbar": "表格",
