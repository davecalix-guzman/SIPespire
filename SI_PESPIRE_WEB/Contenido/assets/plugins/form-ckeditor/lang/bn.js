...
CKEDITOR.lang['bn'] = {
    ...
    "clipboard":
    {
        "copy": "কপি",
        "copyError":
            "আপনার ব্রাউজারের সুরক্ষা সেটিংস এডিটরকে অটোমেটিক কপি করার অনুমতি দেয়নি। দয়া করে এই কাজের জন্য কিবোর্ড ব্যবহার করুন (Ctrl/Cmd+C)।",
        "cut": "কাট",
        "cutError":
    ...
    "indent": { "indent": "ইনডেন্ট বাড়াও", "outdent": "ইনডেন্ট কমাও" },
    "format":
    {
        "label": "ফন্ট ফরমেট",
