...
CKEDITOR.lang['ko'] = {
    ...
    "elementspath": { "eleLabel": "요소 위치", "eleTitle": "%1 요소" },
    "list": { "bulletedlist": "순서없는 목록", "numberedlist": "순서있는 목록" },
    ...
    "magicline": { "title": "여기에 그래프 삽입" },
    "maximize": { "maximize": "최대", "minimize": "최소" },
    ...
    "table":
    {
        ...
        "cellSpace": "셀 간격",
        "column":
            { "menu": "열(Column)", "insertBefore": "앞에 열 삽입", "insertAfter": "뒤에 열 삽입", "deleteColumn": "세로줄 삭제" },
        "columns": "세로줄",
        "deleteTable": "표 삭제",
        "headers": "해더",
        "headersBoth": "모두",
        ...
        "menu": "표 설정",
        "row": { "menu": "행(Row)", "insertBefore": "앞에 행 삽입", "insertAfter": "뒤에 행 삽입", "deleteRow": "가로줄 삭제" },
        "rows": "가로줄",
        "summary": "요약",
        "title": "표 설정",
        "toolbar": "표",
