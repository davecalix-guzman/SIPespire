...
CKEDITOR.lang['pt'] = {
    ...
    "common":
    {
        ...
        "confirmNewPage":
            "Irão ser perdidas quaisquer alterações não guardadas. Tem certeza que deseja carregar a página nova?",
        ...
        "invalidCssLength":
            "Valor especificado para o campo \"1%\" deve ser um número positivo, com ou sem uma unidade de medida CSS válida (px, %, in, cm, mm, em, ex, pt, or pc).",
        "invalidHtmlLength":
            "Valor especificado para o campo \"1%\" deve ser um número positivo, com ou sem uma unidade de medida HTML válida (px ou %).",
        "invalidInlineStyle":
            "Valor especificado para o estilo em embutido deve ser constituído por uma ou mais tuplas com o formato de \"nome : valor\", separados por ponto e vírgula.",
        "cssLengthTooltip":
            "Digite um número para um valor em pixels ou um número com uma unidade CSS válida (px, %, in, cm, mm, em, ex, pt, or pc).",
    ...
    "clipboard":
    {
        ...
        "pasteMsg":
            "Por favor, cole dentro da seguinte caixa usando o teclado (<STRONG>Ctrl/Cmd+V</STRONG>) e prima <STRONG>OK</STRONG>.",
        "securityMsg":
    ...
    "elementspath": { "eleLabel": "Camninho dos Elementos", "eleTitle": "Elemento %1" },
