...
CKEDITOR.lang['fa'] = {
    ...
    "common":
    {
        ...
        "confirmNewPage":
            "هر تغییر ایجاد شدهی ذخیره نشده از بین خواهد رفت. آیا اطمینان دارید که قصد بارگیری صفحه جدیدی را دارید؟",
        ...
        "invalidInlineStyle":
            "عدد تعیین شده برای سبک درونخطی -Inline Style- باید دارای یک یا چند چندتایی با شکلی شبیه \"name : value\" که باید با یک \";\" از هم جدا شوند.",
        "cssLengthTooltip":
    ...
    "contextmenu": { "options": "گزینههای منوی زمینه" },
    "toolbar":
    {
    ...
    "list": { "bulletedlist": "فهرست نقطهای", "numberedlist": "فهرست شمارهدار" },
    ...
    "pastetext": { "button": "چسباندن به عنوان متن ساده", "title": "چسباندن به عنوان متن ساده" },
    "pastefromword":
    {
        "confirmCleanup":
    ...
    "specialchar":
        { "options": "گزینههای نویسههای ویژه", "title": "گزینش نویسهی ویژه", "toolbar": "گنجاندن نویسهی ویژه" },
    "scayt":
    {
        "about": "درباره SCAYT",
        "aboutTab": "درباره",
