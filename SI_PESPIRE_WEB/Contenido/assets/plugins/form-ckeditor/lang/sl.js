...
CKEDITOR.lang['sl'] = {
    ...
    "common":
    {
        ...
        "invalidCssLength":
            "Vrednost določena za \"%1\" polje mora biti pozitivna številka z ali brez veljavne CSS enote za merjenje (px, %, in, cm, mm, em, ex, pt, ali pc).",
        "invalidHtmlLength":
            "Vrednost določena za \"%1\" polje mora biti pozitivna številka z ali brez veljavne HTML enote za merjenje (px ali %).",
        "invalidInlineStyle":
            "Vrednost določena za inline slog mora biti sestavljena iz ene ali več tork (tuples) z obliko \"ime : vrednost\", ločenih z podpičji.",
        "cssLengthTooltip":
            "Vnesite številko za vrednost v slikovnih pikah (pixels) ali številko z veljavno CSS enoto (px, %, in, cm, mm, em, ex, pt, ali pc).",
    ...
    "clipboard":
    {
        ...
        "pasteMsg":
            "Prosim prilepite v sleči okvir s pomočjo tipkovnice (<STRONG>Ctrl/Cmd+V</STRONG>) in pritisnite <STRONG>V redu</STRONG>.",
        "securityMsg":
    ...
    "elementspath": { "eleLabel": "Pot elementov", "eleTitle": "%1 element" },
    "list": { "bulletedlist": "Označen seznam", "numberedlist": "Oštevilčen seznam" },
    ...
    "pastetext": { "button": "Prilepi kot golo besedilo", "title": "Prilepi kot golo besedilo" },
    "pastefromword":
    {
        "confirmCleanup":
            "Besedilo, ki ga želite prilepiti je kopirano iz Word-a. Ali ga želite očistiti, preden ga prilepite?",
    ...
    "specialchar":
        { "options": "Možnosti Posebnega Znaka", "title": "Izberi Posebni Znak", "toolbar": "Vstavi posebni znak" },
    "scayt":
    {
    ...
    "undo": { "redo": "Ponovi", "undo": "Razveljavi" },
    "wsc": {
        "btnIgnore": "Prezri",
