...
var array_map = function(array, callback) {
    ...
    if (Array.prototype.map && array.map === Array.prototype.map) {
        array_return = Array.prototype.map.call(array,
            function(item) {
    ...
    var GMaps = function(options) {
        ...
        var self = this,
            ...
            events_that_hide_context_menu = [
                "bounds_changed", "center_changed", "click", "dblclick", "drag", "dragend", "dragstart", "idle",
                "maptypeid_changed", "projection_changed", "resize", "tilesloaded", "zoom_changed"
            ],
            events_that_doesnt_hide_context_menu = ["mousemove", "mouseout", "mouseover"],
            options_to_be_deleted = [
                "el", "lat", "lng", "mapType", "width", "height", "markerClusterer", "enableNewStyle"
            ],
...
GMaps.prototype.createControl = function(options) {
    ...
    for (var ev in options.events) {
        (function(object, name) {
            google.maps.event.addDomListener(object,
                name,
                function() {
...
GMaps.prototype.createMarker = function(options) {
    ...
    var marker_events_with_mouse = [
        "dblclick", "drag", "dragend", "dragstart", "mousedown", "mouseout", "mouseover", "mouseup"
    ];
    ...
    if (marker.fences) {
        google.maps.event.addListener(marker,
            "dragend",
            function() {
                self.checkMarkerGeofence(marker,
                    function(m, f) {
                        outside(m, f);
                    });
            });
...
GMaps.prototype.getElevations = function(options) {
    ...
    if (!options.path) {
        ...
        service.getElevationForLocations(options,
            function(result, status) {
        ...
        service.getElevationAlongPath(pathRequest,
            function(result, status) {
                if (callback && typeof(callback) === "function") {
                    callback(result, status);
                }
...
GMaps.createPanorama = function(options) {
    ...
    var streetview_events = [
            "closeclick", "links_changed", "pano_changed", "position_changed", "pov_changed", "resize",
            "visible_changed"
        ],
