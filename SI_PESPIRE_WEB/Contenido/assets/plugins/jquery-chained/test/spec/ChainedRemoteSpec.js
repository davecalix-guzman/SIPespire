...
describe("Remote version of plugin",
    function() {
        "use strict";
        ...
        beforeEach(function() {
            ...
            server.respondWith("GET",
                "/api/engines?series=series-6&model=coupe",
                [
                    200, { "Content-Type": "application/json" },
                    '{"":"--","30-petrol":"3.0 petrol"}'
                ]);
            server.respondWith("GET",
                "/api/engines?series=series-3&model=sedan",
                [
                    200, { "Content-Type": "application/json" },
                    '{"":"--","25-petrol":"2.5 petrol","30-petrol":"3.0 petrol","30-diesel":"3.0 diesel"}'
                ]);
            server.respondWith("GET",
                "/api/engines?series=series-3&model=",
                [
                    200, { "Content-Type": "application/json" },
                    '{"":"--","25-petrol":"2.5 petrol","30-petrol":"3.0 petrol"}'
                ]);
            server.respondWith("GET",
                "/api/engines?series=a5&model=sportback",
                [
                    200, { "Content-Type": "application/json" },
                    '{"":"--","30-petrol":"3.0 petrol","30-diesel":"3.0 diesel"}'
                ]);
            server.respondWith("GET",
                "/api/engines?series=&model=",
                [
                    200, { "Content-Type": "application/json" },
                    '{"":"--"}'
                ]);
        ...
        describe("having single set of selects",
            function() {
                ...
                describe("and using new syntax",
                    function() {
                        ...
                        it("should update series when mark changes",
                            function() {
                                runs(function() {
                        ...
                        it("should update model when series changes",
                            function() {
                                runs(function() {
                                    $("#mark").val("bmw").trigger("change");
                                });
                        ...
                        it("should reset series and model when mark changes",
                            function() {
                                runs(function() {
                                    $("#mark").val("audi").trigger("change");
                                });
                        ...
                        it("should disable input if only default value exists",
                            function() {
                                runs(function() {
                                    $("#mark").val("audi").trigger("change");
                                });
                        ...
                        it("should be chained to two parents",
                            function() {
                                runs(function() {
                                    $("#mark").val("bmw").trigger("change");
                                });
                        ...
                        it("should honour selected attribute in json",
                            function() {
                                runs(function() {
                                    $("#mark").val("audi").trigger("change");
                                });
                        ...
                        it("should be able to bootstrap with array of objects",
                            function() {
                        ...
                        it("should be able to bootstrap with array of arrays",
                            function() {
                                $("#series5").remoteChained({
                                    parents: "#mark5",
                                    url: "/api/series",
                        ...
                        it("should be able to bootstrap with object",
                            function() {
                                $("#series5").remoteChained({
                                    parents: "#mark5",
                                    url: "/api/series",
                        ...
                        it("should honour selected attribute in bootstrapped values",
                            function() {
                        ...
                        it("should clear selects while loading",
                            function() {
                        ...
                        it("should show disabled loading text while loading",
                            function() {
                                runs(function() {
                                    $("#mark2").val("bmw").trigger("change");
                                    expect($("#mark2 > option").size()).toBe(3);
                        ...
                        it("should be chained to normal text input",
                            function() {
                                runs(function() {
        ...
        describe("having multiple set of selects",
            function() {
                ...
                describe("and using new syntax",
                    function() {
                        ...
                        xit("should update model when series changes",
                            function() {
                                $("#mark").val("bmw").trigger("change");
                                $("#series").val("series-3").trigger("change");
                                expect($("#mark > option").size()).toBe(3);
