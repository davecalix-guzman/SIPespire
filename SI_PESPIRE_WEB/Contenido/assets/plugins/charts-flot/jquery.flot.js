    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                legend: {
                    ...
                    container:
                        null, // container (as jQuery object) to put legend in, null means default on top of graph
                ...
                xaxis: {
                    ...
                    font:
                        null, // null (derived from CSS in placeholder) or object like { size: 11, lineHeight: 13, style: "italic", weight: "bold", family: "sans-serif", variant: "small-caps" }
                    ...
                    ticks:
                        null, // either [1, 3] or [[1, "a"], 3] or (fn: axis info -> ticks) or app. number of ticks for auto-ticks
            ...
            $.each(allAxes(),
                function(_, axis) {
                    ...
                    if (axis.reserveSpace)
                        margins[dir] =
                            Math.ceil(Math.max(margins[dir], (dir == "x" ? axis.labelWidth : axis.labelHeight) / 2));
                });
        ...
        function drawSeriesBars(series) {
            ...
            var fillStyleCallback = series.bars.fill
                ? function(bottom, top) { return getFillStyle(series.bars, series.color, bottom, top); }
                : null;
            plotBars(series.datapoints,
                barLeft,
                barLeft + series.bars.barWidth,
                0,
                fillStyleCallback,
        ...
        function onClick(e) {
            triggerClickHoverEvent("plotclick",
                e,
