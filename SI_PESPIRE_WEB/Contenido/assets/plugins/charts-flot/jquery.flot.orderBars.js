...
(function($) {
    function init(plot) {
            ...
            if (serieNeedToBeReordered(serie)) {
                ...
                if (nbOfBarsToOrder >= 2) {
                    ...
                    if (isBarAtLeftOfCenter(position)) {
                        ...
                        decallage = sumWidth(orderedBarSeries, Math.ceil(nbOfBarsToOrder / 2), position - 2) +
                            centerBarShift +
        ...
        function calculPixel2XWidthConvert(plot) {
            ...
            var minMaxValues =
                isHorizontal ? getAxeMinMaxValues(plot.getData(), 1) : getAxeMinMaxValues(plot.getData(), 0);
