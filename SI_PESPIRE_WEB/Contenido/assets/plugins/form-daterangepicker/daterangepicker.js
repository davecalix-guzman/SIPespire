...
!function($) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.leftCalendar = {
            month: moment([
                this.startDate.year(), this.startDate.month(), 1, this.startDate.hour(), this.startDate.minute()
            ]),
            calendar: []
        };
    ...
    DateRangePicker.prototype = {
        ...
        updateCalendars: function() {
            this.leftCalendar.calendar = this.buildCalendar(this.leftCalendar.month.month(),
                this.leftCalendar.month.year(),
                this.leftCalendar.month.hour(),
                this.leftCalendar.month.minute(),
                "left");
            this.rightCalendar.calendar = this.buildCalendar(this.rightCalendar.month.month(),
        ...
        renderCalendar: function(calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html +=
                    '<th class="prev available"><i class="fa fa-arrow-left glyphicon glyphfa fa-arrow-left"></i></th>';
            } else {
                html += "<th></th>";
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html +=
                    '<th class="next available"><i class="fa fa-arrow-right glyphicon glyphfa fa-arrow-right"></i></th>';
            } else {
                html += "<th></th>";
            }
    ...
    $.fn.daterangepicker = function(options, cb) {
        this.each(function() {
            ...
            if (!el.data("daterangepicker")) {
                var drp = new DateRangePicker(el, options, cb);
