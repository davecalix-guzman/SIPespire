...
(function($) {
    ...
    var methods = {
        ...
        _buildNotification: function($this) {
            ...
            // add the notification to the stack
            $('.jquery-notific8-container.' + data.settings.verticalEdge + '.' + data.settings.horizontalEdge)
                .append(notification);
    ...
    $.notific8 = function(message, options) {
        ...
        default:
            ...
            if ((!options.hasOwnProperty('verticalEdge')) ||
                ((options.verticalEdge.toLowerCase() != 'right') && (options.verticalEdge.toLowerCase() != 'left'))) {
                options.verticalEdge = settings.verticalEdge;
            }
            if ((!options.hasOwnProperty('horizontalEdge')) ||
            ((options.horizontalEdge.toLowerCase() != 'top') &&
                (options.horizontalEdge.toLowerCase() != 'bottom'))) {
            ...
            $('.jquery-notific8-container.' + options.verticalEdge + '.' + options.horizontalEdge)
