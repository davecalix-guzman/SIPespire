 ...
 */
        ...
        (function(window, document, Chartist) {
            ...
            Chartist.createSvg = function(container, width, height, className) {
                ...
                Array.prototype.slice.call(container.querySelectorAll("svg")).filter(
                    function filterChartistSvgObjects(svg) {
            ...
            Chartist.getAvailableHeight = function(svg, options) {
                return Math.max((Chartist.stripUnit(options.height) || svg.height()) -
            ...
            Chartist.getBounds = function(axisLength, highLow, scaleMinSpace, referenceValue, onlyInteger) {
                ...
                if (onlyInteger && Chartist.projectLength(axisLength, 1, bounds) >= scaleMinSpace) {
                    ...
                    Chartist.projectLength(axisLength, smallestFactor, bounds) >= scaleMinSpace) {
             ...
             * @param eventEmitter
             */
            Chartist.createLabel = function(position,
                length,
                index,
                labels,
                axis,
                ...
                if (useForeignObject) {
                    ...
                    var content = '<span class="' +
                        ...
                        axis.units.len +
                        ": " +
                        Math.round(positionalData[axis.units.len]) +
                        "px; " +
            ...
            Chartist.Interpolation.cardinal = function(options) {
                ...
                function splitIntoSegments(pathCoordinates, valueData) {
                    ...
                    for (var i = 0; i < pathCoordinates.length; i += 2) {
                        ...
                        if (valueData[i / 2].value === undefined) {
                            ...
                            segments[segments.length - 1].pathCoordinates.push(pathCoordinates[i],
                                pathCoordinates[i + 1]);
                ...
                return function cardinal(pathCoordinates, valueData) {
                    ...
                    if (segments.length > 1) {
                        ...
                        var path = new Chartist.Svg.Path().move(pathCoordinates[0],
                                pathCoordinates[1],
                                false,
                                valueData[0]),
                            z;
                ...
                if (options) {
                    ...
                    if (!this.initializeTimeoutId) {
                        ...
                        this.optionsProvider =
                            Chartist.optionsProvider(this.options, this.responsiveOptions, this.eventEmitter);
                    }
                }
...
/* global Chartist */
        (function(window, document, Chartist) {
            ...
            function removeClass(names) {
                ...
                this._node.setAttribute("class",
                    this.classes(this._node).filter(function(name) {
            ...
            function height() {
                return this._node.clientHeight ||
                    Math.round(getBBoxProperty(this._node, "height")) ||
            ...
            function width() {
                return this._node.clientWidth ||
                    Math.round(getBBoxProperty(this._node, "width")) ||
        ...
        (function(window, document, Chartist) {
            ...
            function stringify() {
                ...
                return this.pathElements.reduce(function(path, pathElement) {
                            var params = elementDescriptions[pathElement.command.toLowerCase()].map(
                                function(paramName) {
             ...
             */
            function scale(x, y) {
                forEachParam(this.pathElements,
            ...
            function transform(transformFnc) {
                forEachParam(this.pathElements,
                    function(pathElement, paramName, pathElementIndex, paramIndex, pathElements) {
                        var transformed = transformFnc(pathElement,
                            paramName,
                            pathElementIndex,
                            paramIndex,
                            pathElements);
            ...
            function splitByCommand(command) {
                ...
                this.pathElements.forEach(function(pathElement) {
                    if (pathElement.command === command.toUpperCase() &&
                ...
                projectedValues.forEach(function(projectedValue, index) {
                    ...
                    if (this.units.pos === "x") {
                        ...
                        if (chartOptions.axisX.position === "start") {
                            ...
                            labelOffset.y =
                                this.chartRect.y1 + chartOptions.axisX.labelOffset.y + (useForeignObject ? 5 : 20);
                        }
                    } else {
                    ...
                    if (axisOptions.showGrid) {
                        Chartist.createGrid(projectedValue,
                            index,
                            this,
                            this.gridOffset,
                    ...
                    if (axisOptions.showLabel) {
                        Chartist.createLabel(projectedValue,
                            labelLength,
                            index,
                            labelValues,
                            this,
        ...
        (function(window, document, Chartist) {
            ...
            function FixedScaleAxis(axisUnit, data, chartRect, options) {
                ...
                this.ticks = options.ticks ||
                    Chartist.times(this.divisor).map(function(value, index) {
            ...
            function projectValue(value) {
                return this.axisLength *
                    (+Chartist.getMultiValue(value, this.units.pos) - this.highLow.low) /
                    (this.highLow.high - this.highLow.low);
            }
        ...
        (function(window, document, Chartist) {
            ...
            function createChart(options) {
                ...
                if (options.axisX.type === undefined) {
                    axisX = new Chartist.StepAxis(Chartist.Axis.units.x,
                        data,
                        chartRect,
                        Chartist.extend({},
                            options.axisX,
                ...
                if (options.axisY.type === undefined) {
                    axisY = new Chartist.AutoScaleAxis(Chartist.Axis.units.y,
                        data,
                        chartRect,
                        Chartist.extend({},
                            options.axisY,
                ...
                axisX.createGridAndLabels(gridGroup,
                    labelGroup,
                    this.supportsForeignObject,
                    options,
                    this.eventEmitter);
                axisY.createGridAndLabels(gridGroup,
                    labelGroup,
                    this.supportsForeignObject,
                    options,
                    this.eventEmitter);
                ...
                data.raw.series.forEach(function(series, seriesIndex) {
                        ...
                        path.pathElements.forEach(function(pathElement) {
                            var point = seriesElement.elem("line",
                                ...
                                options.classNames.point).attr({
                                    'value': pathElement.data.value.x === undefined
                                        ? pathElement.data.value.y
                                        : pathElement.data.value.x + "," + pathElement.data.value.y,
                    ...
                    if (seriesOptions.showArea && axisY.highLow) {
                        ...
                        var areaBase = Math.max(Math.min(seriesOptions.areaBase, axisY.highLow.high),
                            axisY.highLow.low);
...
/* global Chartist */
        (function(window, document, Chartist) {
            ...
            function createChart(options) {
                var data = {
                    raw: this.data,
                    normalized: options.distributeSeries
                        ? Chartist.getDataArray(this.data, options.reverseData).map(function(value) {
                            return [value];
                        })
                ...
                if (options.stackBars) {
                    ...
                    var serialSums = Chartist.serialMap(data.normalized,
                        function serialSums() {
                ...
                if (options.horizontalBars) {
                    labelAxis = axisY = new Chartist.StepAxis(Chartist.Axis.units.y,
                        data,
                        chartRect,
                        {
                    ...
                    valueAxis = axisX = new Chartist.AutoScaleAxis(Chartist.Axis.units.x,
                        data,
                        chartRect,
                        Chartist.extend({},
                            options.axisX,
                    ...
                    labelAxis = axisX = new Chartist.StepAxis(Chartist.Axis.units.x,
                        data,
                        chartRect,
                        {
                            ticks: labelAxisTicks
                    ...
                    valueAxis = axisY = new Chartist.AutoScaleAxis(Chartist.Axis.units.y,
                        data,
                        chartRect,
                        Chartist.extend({},
                            options.axisY,
                ...
                labelAxis.createGridAndLabels(gridGroup,
                    labelGroup,
                    this.supportsForeignObject,
                    options,
                    this.eventEmitter);
                valueAxis.createGridAndLabels(gridGroup,
                    labelGroup,
                    this.supportsForeignObject,
                    options,
                    this.eventEmitter);
                ...
                data.raw.series.forEach(function(series, seriesIndex) {
                    ...
                    data.normalized[seriesIndex].forEach(function(value, valueIndex) {
                        ...
                        if (options.horizontalBars) {
                            projected = {
                                x: chartRect.x1 +
                                    valueAxis.projectValue(value || 0, valueIndex, data.normalized[seriesIndex]),
                                y: chartRect.y1 -
                                    labelAxis.projectValue(value || 0,
                                        labelAxisValueIndex,
                                        data.normalized[seriesIndex])
                            };
                        } else {
                            projected = {
                                x: chartRect.x1 +
                        ...
                        projected[labelAxis.units.pos] += (options.stackBars || options.distributeSeries)
                            ? 0
                            : biPol * options.seriesBarDistance * (options.horizontalBars ? -1 : 1);
                        ...
                        positions[labelAxis.counterUnits.pos + "2"] = options.stackBars
                            ? stackedBarValues[valueIndex]
...
/* global Chartist */
        (function(window, document, Chartist) {
            ...
            function createChart(options) {
                ...
                // Create SVG.js draw
                this.svg = Chartist.createSvg(this.container,
                    options.width,
                    options.height,
                    options.donut ? options.classNames.chartDonut : options.classNames.chartPie);
                // Calculate charting rect
                chartRect = Chartist.createChartRect(this.svg, options, defaultOptions.padding);
                // Get biggest circle radius possible within chartRect
                radius = Math.min(chartRect.width() / 2, chartRect.height() / 2);
                // Calculate total of all series to get reference value or use total reference from optional options
                totalDataSum = options.total ||
                    dataArray.reduce(function(previousValue, currentValue) {
                ...
                for (var i = 0; i < this.data.series.length; i++) {
                    ...
                    var start = Chartist.polarToCartesian(center.x,
                            center.y,
                            radius,
                            startAngle - (i === 0 || hasSingleValInSeries ? 0 : 0.2)),
                    ...
                    if (options.showLabel) {
                        ...
                        var labelPosition = Chartist.polarToCartesian(center.x,
                                center.y,
                                labelRadius,
                                startAngle + (endAngle - startAngle) / 2),
                            interpolatedValue =
                                options.labelInterpolationFnc(this.data.labels ? this.data.labels[i] : dataArray[i], i);
                            ...
                            var labelElement = seriesGroups[i].elem("text",
                                {
                                    dx: labelPosition.x,
                                    dy: labelPosition.y,
                                    'text-anchor': determineAnchorPosition(center,
                                        labelPosition,
