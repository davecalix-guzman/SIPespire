        ...
        submit: function(e) {
            ...
            $.when(this.save(submitValue))
                .done($.proxy(function(response) {
                        ...
                        var res = typeof this.options.success === "function"
                        ...
                        **/
                        this.$div.triggerHandler("save",
                            { newValue: newValue, submitValue: submitValue, response: response });
                    },
                    this))
        ...
        save: function(submitValue) {
            ...
            var pk = (typeof this.options.pk === "function")
                ...
                */
                ...
                (this.options.url &&
                ((this.options.send === "always") ||
                    (this.options.send === "auto" && pk !== null && pk !== undefined)))),
                params;
        ...
        */
        getConfigData: function($element) {
            ...
            $.each($element.data(),
                function(k, v) {
                    if (typeof v !== "object" ||
                        (v && typeof v === "object" && (v.constructor === Object || v.constructor === Array))) {
                        data[k] = v;
                    }
                });
            return data;
        ...
        renderForm: function() {
            this.$form
                ...
                .on({
                    ...
                    rendering:
                        $.proxy(this.setPosition, this), //this allows to place container correctly when loading shown
                    resize:
                        $.proxy(this.setPosition,
                            this), //this allows to re-position container when form size is changed 
...
(function($) {
    ...
    $.extend($.fn.editableContainer.Inline.prototype,
        $.fn.editableContainer.Popup.prototype,
        {
            ...
            innerHide: function() {
                this.$tip.hide(this.options.anim,
                    $.proxy(function() {
                            this.$element.show();
                            this.innerDestroy();
                        },
            ...
            if (this.options.unsavedclass) {
                ...
                */
                ...
                (this.options.savenochange &&
                    this.input.value2str(this.value) !== this.input.value2str(params.newValue));
        ...
        **/
        case "submit": //collects value, validate and submit to server for creating new record
            ...
            if ($.isEmptyObject(errors)) {
                ...
                ajaxOptions.success = typeof config.success === "function"
                    ? function(response) {
                ...
                // ajax error callabck
                ajaxOptions.error = typeof config.error === "function"
                    ? function() {
...
(function($) {
    ...
    Select.defaults = $.extend({},
        $.fn.editabletypes.list.defaults,
        {
            /**
            @property tpl 
...
(function($) {
    ...
    Range.defaults = $.extend({},
        $.fn.editabletypes.number.defaults,
        {
    ...
    Datepicker.prototype = {
        ...
        update: function() {
            ...
            if (arguments && arguments.length && (typeof arguments[0] === "string" || arguments[0] instanceof Date)) {
                ...
                date =
                    this.isInput ? this.element.val() : this.element.data("date") || this.element.find("input").val();
                delete this.element.data().date;
            }
        ...
        showMode: function(dir) {
            ...
            */
            ...
            this.picker.find(">div").hide().filter(".datepicker-" + DPGlobal.modes[this.viewMode].clsName)
                .css("display", "block");
            this.updateNavArrows();
        }
    };
    ...
    $.extend(Date.prototype,
        {
            ...
            value2html: function(value, element) {
                var text = value
                    ? this.dpg.formatDate(value, this.parsedViewFormat, this.options.datepicker.language)
                    : "";
...
(function($) {
    ...
    DateField.defaults = $.extend({},
        $.fn.editabletypes.date.defaults,
        {
            /**
            @property tpl 
            **/
    ...
    $.extend(DateTime.prototype,
        {
            ...
            value2html: function(value, element) {
                ...
                var text = value
                    ? this.dpg.formatDate(this.toUTC(value),
            ...
            */
            parseDate: function(str, format) {
                var date = null, formattedBack;
                if (str) {
                    date = this.dpg.parseDate(str,
                        format,
                        this.options.datetimepicker.language,
                        this.options.formatType);
                    if (typeof str === "string") {
                        formattedBack = this.dpg.formatDate(date,
                            format,
                            this.options.datetimepicker.language,
                            this.options.formatType);
                        if (str !== formattedBack) {
