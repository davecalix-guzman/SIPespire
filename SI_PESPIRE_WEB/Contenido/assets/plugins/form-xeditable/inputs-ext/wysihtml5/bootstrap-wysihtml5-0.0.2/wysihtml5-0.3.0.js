...
window["rangy"] = (function() {
    ...
    var textRangeMethods = [
        "collapse", "compareEndPoints", "duplicate", "getBookmark", "moveToBookmark",
...
rangy.createModule("DomRange",
    function(api, module) {
        ...
        function getNodesInRange(range, nodeTypes, filter) {
            ...
            var nodes = [];
            iterateSubtree(new RangeIterator(range, false),
                function(node) {
        ...
        RangeIterator.prototype = {
            ...
            detach: function(detachRange) {
                ...
                this.range = this._current = this._next = this._first = this._last = this.sc = this.so = this.ec =
                    this.eo = null;
            }
        };
        ...
        function isOrphan(node) {
            return !dom.arrayContains(rootContainerNodeTypes, node.nodeType) &&
        ...
        RangePrototype.prototype = {
            ...
            intersectsRange: function(range, touchingIsIntersecting) {
                ...
                var startComparison = dom.comparePoints(this.startContainer,
                        this.startOffset,
                        range.endContainer,
                        range.endOffset),
                    endComparison = dom.comparePoints(this.endContainer,
                        this.endOffset,
            ...
            union: function(range) {
                if (this.intersectsRange(range, true)) {
                    ...
                    if (dom.comparePoints(range.endContainer, range.endOffset, this.endContainer, this.endOffset) ==
                        1) {
            ...
            api.util.extend(constructor.prototype,
                {
                    ...
                    canSurroundContents: function() {
                        ...
                        (iterator._first && (isNonTextPartiallySelected(iterator._first, this)) ||
                            (iterator._last && isNonTextPartiallySelected(iterator._last, this)));
                        iterator.detach();
                        return !boundariesInvalid;
                    },
        ...
        if (api.features.implementsTextRange) {
            WrappedRange.rangeToTextRange = function(range) {
                if (range.collapsed) {
                    ...
                    var startRange =
                        createBoundaryTextRange(new DomPosition(range.startContainer, range.startOffset), true);
    ...
    function(api, module) {
        ...
        if (!useDocumentSelection && selectionHasAnchorAndFocus && api.features.implementsDomRange) {
            selectionIsBackwards = function(sel) {
                var backwards = false;
                if (sel.anchorNode) {
                    backwards = (dom.comparePoints(sel.anchorNode, sel.anchorOffset, sel.focusNode, sel.focusOffset) ==
                        1);
                }
                return backwards;
            };
...
(function(wysihtml5) {
    ...
    function _convertUrlsToLinks(str) {
        return str.replace(URL_REG_EXP,
            function(match, url) {
...
(function(wysihtml5) {
    ...
    wysihtml5.dom.delegate = function(container, selector, eventName, handler) {
        return wysihtml5.dom.observe(container,
            eventName,
            function(event) {
...
wysihtml5.dom.getStyle = (function() {
    ...
    function camelize(str) {
        return str.replace(REG_EXP_CAMELIZE,
            function(match) {
        ...
        return {
            from: function(element) {
                ...
                var win = doc.defaultView || doc.parentWindow,
                    needsOverflowReset = (property === "height" || property === "width") &&
    ...
    wysihtml5.quirks.ensureProperClearingOfLists = (function() {
        ...
        var clearIfNecessary = function(element, contentEditableElement) {
            if (!contentEditableElement.firstChild ||
                !wysihtml5.lang.array(ELEMENTS_THAT_CONTAIN_LI).contains(contentEditableElement.firstChild.nodeName)) {
                return;
            }
        ...
        /** @scope wysihtml5.Selection.prototype */
        {
            ...
            scrollIntoView: function() {
                var doc = this.doc,
                    ...
                    tempElement = doc._wysihtml5ScrollIntoViewElement = doc._wysihtml5ScrollIntoViewElement ||
                    (function() {
...
(function(wysihtml5, rangy) {
    ...
    function splitNodeAt(node, descendantNode, descendantOffset) {
        ...
        return (descendantNode == node)
            ? newNode
            : splitNodeAt(node, newNode.parentNode, rangy.dom.getNodeIndex(newNode));
    }
        ...
        getAncestorWithClass: function(node) {
            ...
            while (node) {
                ...
                if (node.nodeType == wysihtml5.ELEMENT_NODE &&
                    rangy.dom.arrayContains(this.tagNames, node.tagName.toLowerCase()) &&
                    cssClassMatch) {
                    return node;
                }
                node = node.parentNode;
...
(function(wysihtml5) {
    ...
    wysihtml5.commands.fontSize = {
        exec: function(composer, command, size) {
            return wysihtml5.commands.formatInline.exec(composer,
                command,
                "span",
        ...
        state: function(composer, command, size) {
            return wysihtml5.commands.formatInline.state(composer,
                command,
                "span",
                "wysiwyg-font-size-" + size,
                REG_EXP);
...
(function(wysihtml5) {
    ...
    function _execCommand(doc, command, nodeName, className) {
        if (className) {
            var eventListener = dom.observe(doc,
                "DOMNodeInserted",
                function(event) {
                    var target = event.target,
                        displayStyle;
    ...
    function _getApplier(tagName, className, classRegExp) {
        ...
        if (!htmlApplier[identifier]) {
            htmlApplier[identifier] =
                new wysihtml5.selection.HTMLApplier(_getTagNames(tagName), className, classRegExp, true);
        }
...
(function(wysihtml5) {
    ...
    wysihtml5.commands.insertImage = {
        ...
        state: function(composer) {
            ...
            imagesInSelection = composer.selection.getNodes(wysihtml5.ELEMENT_NODE,
                function(node) {
    ...
    /** @scope wysihtml5.views.View.prototype */
    {
        ...
        _observeViewChange: function() {
            ...
            this.parent.observe("beforeload",
                function() {
                    that.parent.observe("change_view",
                        function(view) {
                            if (view === that.name) {
        ...
        /** @scope wysihtml5.views.Composer.prototype */
        {
            ...
            _initAutoLinking: function() {
                ...
                if (!supportsAutoLinking || (supportsAutoLinking && supportsDisablingOfAutoLinking)) {
                    this.parent.observe("newword:composer",
                        function() {
...
(function(wysihtml5) {
    ...
    wysihtml5.views.Composer.prototype.style = function() {
        ...
        if (!wysihtml5.browser.hasCurrentStyleProperty()) {
            var winObserver = dom.observe(win,
                "resize",
                function() {
    ...
    wysihtml5.views.Composer.prototype.observe = function() {
        ...
        dom.observe(element,
            ...
            function(event) {
                ...
                if (target &&
                    target.nodeName === "IMG" &&
                    (keyCode === wysihtml5.BACKSPACE_KEY || keyCode === wysihtml5.DELETE_KEY)
...
wysihtml5.views.Textarea = wysihtml5.views.View.extend(
    /** @scope wysihtml5.views.Textarea.prototype */
    {
        ...
        _observe: function() {
            ...
            parent.observe("beforeload",
                function() {
                    wysihtml5.dom.observe(element,
                        events,
                        function(event) {
        ...
        /** @scope wysihtml5.toolbar.Toolbar.prototype */
        {
            ...
            _getLinks: function(type) {
                var links = this[type + "Links"] = wysihtml5.lang
                        .array(this.container.querySelectorAll("[data-wysihtml5-" + type + "]")).get(),
                    length = links.length,
                    i = 0,
                    ...
                    dialog.observe("show",
                        function() {
                            ...
                            that.editor.fire("show:dialog",
                                { command: command, dialogContainer: dialogElement, commandLink: link });
                        });
            ...
            _observe: function() {
                ...
                editor.observe("blur:composer",
                    function() {
                        clearInterval(that.interval);
                    });

                editor.observe("destroy:composer",
                    function() {
                        clearInterval(that.interval);
                    });

                editor.observe("change_view",
    ...
    wysihtml5.Editor = wysihtml5.lang.Dispatcher.extend(
        /** @scope wysihtml5.Editor.prototype */
        {
            constructor: function(textareaElement, config) {
                this.textareaElement = typeof(textareaElement) === "string"
