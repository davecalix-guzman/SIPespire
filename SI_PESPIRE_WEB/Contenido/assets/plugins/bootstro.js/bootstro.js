    ...
    (function(bootstro, $, undefined) {
        ...
        function add_nav_btn(content, i) {
            ...
            if ($el.attr("data-bootstro-nextButton")) {
                ...
                nextButton = '<button class="' +
                    defaultBtnClass +
                    ' bootstro-next-btn">' +
                    $el.attr("data-bootstro-nextButtonText") +
                    "</button>";
            } else {
            ...
            if ($el.attr("data-bootstro-prevButton")) {
                ...
                prevButton = '<button class="' +
                    defaultBtnClass +
                    ' bootstro-prev-btn">' +
                    $el.attr("data-bootstro-prevButtonText") +
                    "</button>";
            } else {
            ...
            if ($el.attr("data-bootstro-finishButton")) {
                ...
                finishButton = '<button class="' +
                    defaultBtnClass +
                    ' bootstro-finish-btn">' +
                    $el.attr("data-bootstro-finishButtonText") +
                    "</button>";
            } else {
        ...
        get_popup = function(i) {
            ...
            p.template = '<div class="popover" style="' +
                style +
