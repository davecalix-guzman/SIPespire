 ...
 */
        var ColReorder = function(dt, opts) {
            ...
            oDTSettings.oApi._fnCallbackReg(oDTSettings,
                'aoDestroyCallback',
	 ...
	 */
            ...
            "_fnConstruct": function() {
                ...
                /* State saving */
                this.s.dt.oApi._fnCallbackReg(this.s.dt,
                    'aoStateSaveParams',
                    function(oS, oData) {
                ...
                if (this.s.dt.oLoadedState &&
                    typeof this.s.dt.oLoadedState.ColReorder != 'undefined' &&
            ...
            "_fnOrderColumns": function(a) {
                if (a.length != this.s.dt.aoColumns.length) {
                    this.s.dt.oInstance.oApi._fnLog(this.s.dt,
                        1,
            ...
            "_fnMouseDown": function(e, nTh) {
                ...
                $(document)
                    .on('mousemove.ColReorder',
                        function(e) {
                            that._fnMouseMove.call(that, e);
                        })
                    .on('mouseup.ColReorder',
                        function(e) {
            ...
            "_fnMouseMove": function(e) {
                ...
                for (var i = 1, iLen = this.s.aoTargets.length; i < iLen; i++) {
                    if (e.pageX <
                        this.s.aoTargets[i - 1].x + ((this.s.aoTargets[i].x - this.s.aoTargets[i - 1].x) / 2)) {
