...
(/** @lends <global> */function(window, document, undefined) {
    ...
    (/** @lends <global> */
        function($) {
            ...
            function _fnGetCellData(settings, rowIdx, colIdx, type) {
                ...
                var cellData = col.fnGetData(rowData,
                    type,
                    {
                        settings: settings,
                        row: rowIdx,
            ...
            */
            ...
            function _fnBuildAjax(oSettings, data, fn) {
                ...
                if (oSettings.fnServerData) {
                    ...
                    oSettings.fnServerData.call(instance,
                        ...
                        $.map(data,
                            function(val, key) { // Need to convert back to 1.9 trad format
            ...
            function _fnFeatureHtmlFilter(settings) {
                ...
                $(settings.nTable).on('search.dt.DT',
                    function(ev, s) {
                        if (settings === s) {
            ...
            function _fnFeatureHtmlLength(settings) {
                ...
                $(settings.nTable).bind('length.dt.DT',
                    function(e, s, len) {
                        if (settings === s) {
                            $('select', div).val(len);
                        }
            ...
            function _fnScrollDraw(settings) {
                ...
                $.each(_fnGetUniqueThs(settings, headerCopy),
                    function(i, el) {
            ...
            function _fnCalculateColumnWidths(oSettings) {
                ...
                if ((tableWidthAttr || scrollX) && ! oSettings._reszEvt) {
                    $(window).bind('resize.DT-' + oSettings.sInstance,
            ...
            function _fnSortData(settings, idx) {
                ...
                if (customSort) {
                    customData = customSort.call(settings.oInstance,
                        settings,
                        idx,
            ...
            function _fnSaveState(settings) {
                ...
                var state = {
                    ...
                    columns: $.map(settings.aoColumns,
                        function(col, i) {
                            return {
            ...
            function _fnLog(settings, level, msg, tn) {
                msg = 'DataTables warning: ' +
                    (settings !== null ? 'table id=' + settings.sTableId + ' - ' : '') +
                    msg;
            ...
            function _fnCallbackFire(settings, callbackArr, e, args) {
                ...
                if (callbackArr) {
                    ret = $.map(settings[callbackArr].slice().reverse(),
                        function(val, i) {
                ...
                this.each(function() {
                    ...
                    if (oInit.aLengthMenu && ! oInit.iDisplayLength) {
                        oInit.iDisplayLength =
                            $.isArray(oInit.aLengthMenu[0]) ? oInit.aLengthMenu[0][0] : oInit.aLengthMenu[0];
                    }
                    ...
                    if (oInit.oLanguage.sUrl !== "") {
                        ...
                        $.getJSON(oSettings.oLanguage.sUrl,
                            null,
                            function(json) {
                    ...
                    if (rowOne.length) {
                        ...
                        $.each(_fnGetRowElements(oSettings, rowOne[0]).cells,
                            function(i, cell) {
            ...
            _api_registerPlural('tables().nodes()',
                'table().node()',
                function() {
            ...
            _api_registerPlural('tables().body()',
                'table().body()',
                function() {
                    return this.iterator('table',
                        function(ctx) {
            ...
            _api_registerPlural('tables().header()',
                'table().header()',
                function() {
                    return this.iterator('table',
                        function(ctx) {
            ...
            _api_registerPlural('tables().footer()',
                'table().footer()',
                function() {
                    return this.iterator('table',
                        function(ctx) {
            ...
            _api_registerPlural('tables().containers()',
                'table().container()',
                function() {
                    return this.iterator('table',
                        function(ctx) {
	 ...
	 */
             ...
             * @returns {DataTables.Api} this
             */
            _api_register('ajax.reload()',
                function(callback, resetPaging) {
                    return this.iterator('table',
                        function(settings) {
	 ...
	 */
            ...
            _api_registerPlural('rows().cache()',
                'row().cache()',
                function(type) {
                    return this.iterator('row',
                        function(settings, row) {
            ...
            _api_registerPlural('rows().indexes()',
                'row().index()',
                function() {
                    return this.iterator('row',
                        function(settings, row) {
            ...
            _api_registerPlural('rows().remove()',
                'row().remove()',
                function() {
                    var that = this;

                    return this.iterator('row',
                        function(settings, row, thatIdx) {
                            var data = settings.aoData;
            ...
            _api_register('rows.add()',
                function(rows) {
                    var newRows = this.iterator('table',
                        function(settings) {
                            var row, i, ien;
                            var out = [];
             ...
             *
             */
            _api_registerPlural('columns().header()',
                'column().header()',
                function(selector, opts) {
             ...
             *
             */
            _api_registerPlural('columns().footer()',
                'column().footer()',
                function(selector, opts) {
                    return this.iterator('column',
                        function(settings, column) {
             ...
             *
             */
            _api_registerPlural('columns().data()',
                'column().data()',
                function() {
            ...
            _api_registerPlural('columns().cache()',
                'column().cache()',
                function(type) {
                    return this.iterator('column-rows',
                        function(settings, column, i, j, rows) {
                            return _pluck_order(settings.aoData,
                                rows,
            ...
            _api_registerPlural('columns().nodes()',
                'column().nodes()',
                function() {
                    return this.iterator('column-rows',
                        function(settings, column, i, j, rows) {
            ...
            _api_registerPlural('columns().visible()',
                'column().visible()',
                function(vis) {
                    return this.iterator('column',
                        function(settings, column) {
            ...
            _api_registerPlural('columns().indexes()',
                'column().index()',
                function(type) {
                    return this.iterator('column',
                        function(settings, column) {
            ...
            _api_registerPlural('cells().nodes()',
                'cell().node()',
                function() {
            ...
            _api_registerPlural('cells().cache()',
                'cell().cache()',
                function(type) {
            ...
            _api_registerPlural('cells().indexes()',
                'cell().index()',
                function() {
                    return this.iterator('cell',
                        function(settings, row, column) {
	 ...
	 */
            ...
            DataTable.tables = DataTable.fnTables = function(visible) {
                return jQuery.map(DataTable.settings,
                    function(o) {
