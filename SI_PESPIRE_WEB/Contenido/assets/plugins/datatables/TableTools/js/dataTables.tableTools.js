 ...
 */
            TableTools = function(oDT, oOpts) {
                ...
                // sources
                var dtSettings = $.fn.dataTable.Api ? new $.fn.dataTable.Api(oDT).settings()[0] : oDT.fnSettings();
            ...
            TableTools.prototype = {
                ...
                "fnSelectAll": function(filtered) {
                    ...
                    this._fnRowSelect((filtered === true) ? s.dt.aiDisplay : s.dt.aoData
                    );
                },
                ...
                "_fnCollectionHide": function(nButton, oConfig) {
                    ...
                    if (this.dom.collection.collection !== null) {
                        $(this.dom.collection.collection).animate({ "opacity": 0 },
                            500,
                            function(e) {
                                this.style.display = "none";
                            });

                        $(this.dom.collection.background).animate({ "opacity": 0 },
                            500,
                            function(e) {
                ...
                "_fnRowSelectConfig": function() {
                    if (this.s.master) {
                        ...
                        if (this.s.select.type === 'os') {
                            $(dt.nTBody).on('mousedown.DTTT_Select',
                                'tr',
                                function(e) {
                                    if (e.shiftKey) {
                            ...
                            $(dt.nTBody).on('mouseup.DTTT_Select',
                                'tr',
                                function(e) {
                        ...
                        // Row selection
                        $(dt.nTBody).on('click.DTTT_Select',
                            this.s.custom.sRowSelector,
                            function(e) {
                                var row = this.nodeName.toLowerCase() === 'tr' ? this : $(this).parents('tr')[0];
                ...
                "_fnRowSelect": function(src, e) {
                    ...
                    if (this.s.select.preRowSelect !== null &&
                        !this.s.select.preRowSelect.call(this, e, anSelected, true)) {
                        return;
                    }
                ...
                "_fnRowDeselect": function(src, e) {
                    ...
                    // User defined pre-selection function
                    if (this.s.select.preRowSelect !== null &&
                        !this.s.select.preRowSelect.call(this, e, anDeselectedTrs, false)) {
                        return;
                    }
                ...
                "_fnTextConfig": function(nButton, oConfig) {
                    ...
                    if (oConfig.fnSelect !== null) {
                        TableTools._fnEventListen(this,
                            'select',
                            function(n) {
                ...
                "_fnFlashConfig": function(nButton, oConfig) {
                    ...
                    flash.addEventListener('complete',
                ...
                "_fnGetDataTablesData": function(oConfig) {
                    ...
                    for (j = 0, jLen = aDataIndex.length; j < jLen; j++) {
                        ...
                        if (oConfig.bOpenRows) {
                            ...
                            if (arr.length === 1) {
                                sLoopData =
                                    this._fnBoundData($('td', arr[0].nTr).html(), oConfig.sFieldBoundary, regex);
                    ...
                    TableTools.buttonBase,
                    {
                        ...
                        "fnClick": function(nButton, oConfig, flash) {
                            this.fnSetText(flash,
                                ...
                                "\n" +
                                "colWidth:" +
                                this.fnCalcColRatios(oConfig) +
                                "\n" +
                                "orientation:" +
                                oConfig.sPdfOrientation +
                                "\n" +
                                "size:" +
                                oConfig.sPdfSize +
                                "\n" +
...
// tabletools() method simply returns the instance.
            ...
            if ($.fn.dataTable.Api) {
                $.fn.dataTable.Api.register('tabletools()',
                    function() {
                        var tt = null;
            ...
            if (typeof $.fn.dataTable == "function" &&
                ...
                $.fn.dataTableExt.aoFeatures.push({
                    "fnInit": function(oDTSettings) {
                        ...
                        var opts = init ? init.tableTools || init.oTableTools || {} : {};
