    ...
    $.extend(PNotify.prototype,
        {
            ...
            runModules: function(event, arg) {
                ...
                for (var module in this.modules) {
                    ...
                    if (typeof this.modules[module][event] === "function")
                        this.modules[module][event](this,
                            typeof this.options[module] === "object" ? this.options[module] : {},
                            curArg);
                }
            },
            ...
            update: function(options) {
                ...
                if (this.options.cornerclass !== oldOpts.cornerclass)
                    this.container.removeClass("ui-corner-all " + oldOpts.cornerclass)
                ...
                if (this.options.icon !== oldOpts.icon ||
                    (this.options.icon === true && this.options.type !== oldOpts.type)) {
                    // Remove any old icon.
            ...
            animateIn: function(callback) {
                ...
                if (animation === "none") {
                    ...
                    this.elem.show(animation,
                        (typeof this.options.animation.options_in === "object" ? this.options.animation.options_in : {}
                        ),
                        this.options.animate_speed,
                        callback);
            },
            ...
            animateOut: function(callback) {
                ...
                if (animation === "none") {
                    ...
                    this.elem.hide(animation,
                        (typeof this.options.animation.options_out === "object"
                            ? this.options.animation.options_out
                            : {}),
                        this.options.animate_speed,
                        callback);
            },
            ...
            position: function(dontSkipHidden) {
                ...
                if (!hidden || dontSkipHidden) {
                    ...
                    if ((s.dir1 === "down" &&
                            s.nextpos1 + this.elem.height() >
                            (s.context.is(body) ? jwindow.height() : s.context.prop("scrollHeight"))) ||
                        (s.dir1 === "up" &&
                            s.nextpos1 + this.elem.height() >
                            (s.context.is(body) ? jwindow.height() : s.context.prop("scrollHeight"))) ||
                        (s.dir1 === "left" &&
                            s.nextpos1 + this.elem.width() >
                            (s.context.is(body) ? jwindow.width() : s.context.prop("scrollWidth"))) ||
                        (s.dir1 === "right" &&
                            s.nextpos1 + this.elem.width() >
                            (s.context.is(body) ? jwindow.width() : s.context.prop("scrollWidth")))) {
                    ...
                    if (typeof s.nextpos1 === "number") {
                        ...
                        if (s.animation &&
                            (curpos1 > s.nextpos1 || animate.top || animate.bottom || animate.right || animate.left)) {
                            switch (s.dir1) {
                            case "down":
    ...
    PNotify.prototype.modules.buttons = {
        ...
        init: function(notice, options) {
            ...
            this.sticker = $("<div />",
                ...
                .bind("pnotify_icon",
                    function() {
                        $(this).children().removeClass(notice.styles.pin_up + " " + notice.styles.pin_down)
                            .addClass(notice.options.hide ? notice.styles.pin_up : notice.styles.pin_down);
                    })
