...
(function($, undefined) {
    ...
    function local(options) {
        ...
        if (dataItem.text) {
            ...
            if (!$.isFunction(text)) {
                dataText =
                    dataItem.text; // we need to store this in a separate variable because in the next step data gets reset and data.text is no longer available
    ...
    function defaultTokenizer(input, selection, selectCallback, opts) {
        var original =
                input, // store the original so we can compare and know if we need to tell the search to update its text
    ...
    AbstractSelect2 = clazz(Object,
        {
            ...
            init: function(opts) {
                ...
                this.dropdown.on("mousemove-filtered touchstart touchmove touchend",
                    resultsSelector,
                ...
                if ($.fn.mousewheel) {
                    results.mousewheel(function(e, delta, deltaX, deltaY) {
                        ...
                        if (deltaY > 0 && top - deltaY <= 0) {
                            ...
                            results.get(0).scrollHeight - results.scrollTop() + deltaY <= results.height()) {
                ...
                if (below <= this.opts.loadMorePadding) {
                    ...
                    this.opts.query({
                        ...
                        callback: this.bind(function(data) {
                            ...
                            self.opts.populateResults.call(this,
                                results,
                                data.results,
            ...
            updateResults: function(initial) {
                ...
                if (maxSelSize >= 1) {
                    ...
                    if ($.isArray(data) &&
                        ...
                        render("<li class='select2-selection-limit'>" +
                ...
                if (search.val().length < opts.minimumInputLength) {
                    if (checkFormatter(opts.formatInputTooShort, "formatInputTooShort")) {
                        render("<li class='select2-no-results'>" +
                ...
                opts.query({
                    ...
                    callback: this.bind(function(data) {
                        ...
                        if (data.more === true && checkFormatter(opts.formatLoadMore, "formatLoadMore")) {
                            results.append("<li class='select2-more-results'>" +
    ...
    SingleSelect2 = clazz(AbstractSelect2,
        {
            ...
            initSelection: function() {
                ...
                if (this.isPlaceholderOptionSelected()) {
                    ...
                    var self = this;
                    this.opts.initSelection.call(null,
                        this.opts.element,
                        function(selected) {
                ...
                this.search.on("keydown",
                    this.bind(function(e) {
                        ...
                        (e.which == KEY.LEFT ||
                            ...
                            return;
                        } else if (((e.which === KEY.BACKSPACE && this.keydowns == 1) || e.which == KEY.LEFT) &&
                            (pos.offset == 0 && !pos.length)) {
    ...
    $.fn.select2 = function() {
        ...
        var args = Array.prototype.slice.call(arguments, 0),
            ...
            multiple,
            allowedMethods = [
                "val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "dropdown",
                "onSortStart", "onSortEnd", "enable", "disable", "readonly", "positionDropdown", "data", "search"
            ],
