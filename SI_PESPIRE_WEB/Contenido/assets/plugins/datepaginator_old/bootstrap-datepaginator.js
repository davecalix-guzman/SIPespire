    ...
    DatePaginator.prototype = {
        ...
        _init: function(options) {
            ...
            if (typeof this.options.selectedDate === "string") {
                this.options.selectedDate = moment(this.options.selectedDate, this.options.selectedDateFormat).clone()
                    .startOf("day");
            }
        ...
        _injectStyle: function() {
            ...
            if (this.options.injectStyle && !document.getElementById("bootstrap-datepaginator-style")) {
                $("<style type='text/css' id='bootstrap-datepaginator-style'> " + this._css + " </style>")
                    .appendTo("head");
            }
        },
        ...
        _buildData: function() {
            ...
            var viewWidth = (this.options.width -
                    ((this.options.selectedItemWidth - this.options.itemWidth) + (this.options.navItemWidth * 2))),
                ...
                adjustedSelectedItemWidth =
                    Math.floor(this.options.selectedItemWidth + (viewWidth - (units * adjustedItemWidth))),
            ...
            for (var m = start; m.isBefore(end); m.add("days", 1)) {
                data[data.length] = {
                    ...
                    isOffDay: (this.options.offDays.split(",").indexOf(m.format(this.options.offDaysFormat)) !== -1)
                        ? true
                        : false,
                    isStartOfWeek: (this.options.startOfWeek.split(",")
                            .indexOf(m.format(this.options.startOfWeekFormat)) !==
                            -1)
                        ? true
                        : false,
                    text: (m.isSame(this.options.selectedDate))
                        ? m.format(this.options.textSelected)
                        : m.format(this.options.text),
        ...
        _template: {
            ...
            listItem: "<li></li>",
            navItem: '<a  class="dp-nav"></a>',
            dateItem: '<a  class="dp-item"></a>',
            icon: '<i class="fa"></i>',
