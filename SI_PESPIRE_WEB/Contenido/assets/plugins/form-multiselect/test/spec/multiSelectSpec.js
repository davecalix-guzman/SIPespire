    ...
    function() {
            ...
            function() {
                ...
                describe("without options",
                    function() {
                        ...
                        it("should hide the original select",
                            function() {
                        ...
                        it("should create a selectable and a selection container",
                            function() {
                                expect(msContainer).toContain("div.ms-selectable, div.ms-selection");
                            });

                        it("should create a list for both selectable and selection container",
                            function() {
                                expect(msContainer)
                                    .toContain("div.ms-selectable ul.ms-list, div.ms-selection ul.ms-list");
                            });

                        it("should populate the selectable list",
                            function() {
                                expect($(".ms-selectable ul.ms-list li").length).toEqual(10);
                            });

                        it("should populate the selection list",
                            function() {
                                expect($(".ms-selectable ul.ms-list li").length).toEqual(10);
                            });
                ...
                describe("with pre-selected options",
                    function() {
                        ...
                        it("should select the pre-selected options",
                            function() {
                                $.each(selectedValues,
                                    function(index, value) {
                                        expect($(".ms-selectable ul.ms-list li#" + sanitize(value) + "-selectable"))
                                            .toBe(".ms-selected");
                                    });
        ...
        describe("optgroup",
            function() {
                ...
                beforeEach(function() {
                    $('<select id="multi-select-optgroup" multiple="multiple" name="testy[]"></select>')
                        .appendTo("body");
                    for (var o = 1; o <= 10; o++) {
                ...
                describe("init",
                    function() {
                        describe("with selectableOptgroup option set to false",
                            function() {
                                beforeEach(function() {
                                ...
                                it("sould display all optgroups",
                                    function() {
                                        expect(optgroupLabels.length).toEqual(10);
                                    });

                                it("should do nothing when clicking on optgroup",
                                    function() {
                        ...
                        describe("with selectableOptgroup option set to true",
                            function() {
                                beforeEach(function() {
                                ...
                                it("should select all nested options when clicking on optgroup",
                                    function() {
                                        var clickedOptGroupLabel = optgroupLabels.first();
                                        clickedOptGroupLabel.trigger("click");
        ...
        describe("select",
            function() {
                ...
                describe("multiple values (Array)",
                    function() {
                        ...
                        it("should select corresponding option",
                            function() {
                ...
                describe("on click",
                    function() {
                        ...
                        it("should hide selected item",
                            function() {
                                expect(clickedItem).toBeHidden();
                            });

                        it("should add the .ms-selected class to the selected item",
                            function() {
                        ...
                        it("should show the associated selected item",
                            function() {
                                expect($("#" + sanitize(value) + "-selection")).toBe(":visible");
                            });

                        it("should trigger the original select change event",
                            function() {
            ...
            function() {
                ...
                describe("on click",
                    function() {
                        ...
                        it("should hide clicked item",
                            function() {
                                expect(clickedItem).toBe(":hidden");
                            });

                        it("should show associated selectable item",
                            function() {
                                expect($("#" + value + "-selectable")).toBe(":visible");
                            });

                        it("should remove the .ms-selected class to the corresponding selectable item",
                            function() {
                                expect(correspondingSelectableItem.hasClass("ms-selected")).toBeFalsy();
                            });

                        it("should deselect corresponding option",
                            function() {
