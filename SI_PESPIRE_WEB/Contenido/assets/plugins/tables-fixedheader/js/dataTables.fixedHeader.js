        ...
        FixedHeader.prototype = {
            ...
            _fnScrollHorizontalRight: function(oCache) {
                ...
                if (oWin.iScrollRight < oMes.iTableRight) {
                    ...
                    this._fnUpdateCache(oCache,
                        "sLeft",
                        (oMes.iTableLeft + oMes.iTableWidth - iFixedWidth) + "px",
                        "left",
                        nTable.style);
            ...
            _fnScrollHorizontalLeft: function(oCache) {
                ...
                if (oWin.iScrollLeft < oMes.iTableLeft) {
                    ...
                    this._fnUpdateCache(oCache,
                        "sLeft",
                        (oMes.iTableLeft + oMes.iTableWidth - iCellWidth) + "px",
                        "left",
                        nTable.style);
                }
            },
            ...
            _fnScrollFixedFooter: function(oCache) {
                ...
                if (oWin.iScrollBottom < oMes.iTableBottom) {
                    ...
                    this._fnUpdateCache(oCache,
                        "sTop",
                        (oMes.iTableTop + oMes.iTableHeight - iCellHeight) + "px",
                        "top",
                        nTable.style);
                    this._fnUpdateCache(oCache, "sLeft", oMes.iTableLeft + "px", "left", nTable.style);
            ...
            _fnCloneThead: function(oCache) {
                ...
                // clicked to sort
                $("th.sorting, th.sorting_desc, th.sorting_asc", nTable).bind("click",
                    function() {
                        this.blur();
                    });
            },
