            ...
            function _advanceInputGroup(parentelement) {
                ...
                if (prev.hasClass('input-group-btn')) {
                    downhtml = '<button class="' +
                        ...
                        ' bootstrap-touchspin-down" type="button">-</button>';
                    prev.append(downhtml);
                } else {
                    downhtml = '<span class="input-group-btn"><button class="' +
                        settings.buttondown_class +
                        ' bootstrap-touchspin-down" type="button">-</button></span>';
                ...
                if (next.hasClass('input-group-btn')) {
                    uphtml = '<button class="' +
                        ...
                        ' bootstrap-touchspin-up" type="button">+</button>';
                    next.prepend(uphtml);
                } else {
                    uphtml = '<span class="input-group-btn"><button class="' +
                        settings.buttonup_class +
                        ' bootstrap-touchspin-up" type="button">+</button></span>';
