(function(f) {
    ...
    var c = {
        init: function(q) {
            ...
            n.hide();
            var p =
                '<div class="fs-editor-wrapper">                     <div class="fs-editor"><a  class="fs-icon"></a>                     <div class="fs-editable" contenteditable="true"></div>                     </div></div>';
            ...
            if (d.expandOnFocus) {
                m.on("focus.fseditor", function() { c.expand() })
            }
            i.on("click.fseditor.icon",
                function(t) {
                    t.preventDefault();
                    c[g ? "minimize" : "expand"]()
                });
        ...
        showOverlay: function() {
            f('<div class="fs-editor-overlay" />').appendTo("body").fadeTo(d.transition == "" ? 0 : e, 1)
                .click(function() { c.minimize() });
            return this
        },
        removeOverlay: function() {
            var o = f(".fs-editor-overlay");
            if (o.length) {
                o.fadeTo(d.transition == "" ? 0 : e, 0, function() { f(this).remove() })
            }
            return this
        },
        expand: function() {
            ...
            f(window).on("resize.fseditor", function() { b(a) });
        ...
        minimize: function() {
            ...
            a.removeClass("expanded transition-" + d.transition).css({ "max-width": "none", "max-height": "none" });
            if (d.transition == "fade") {
                a.fadeTo(0, 0)
            }
            if (d.overlay) {
    ...
    var j = {
        ...
        slideInComplete: function(o) {
            if (o == "expand") {
                a.css({ top: -999, opacity: 1 }).animate({ top: 0 | (((f(window).height() - a.height()) / 2)) }, e);
                g = true;
                d.onExpand.call(this)
            } else {
                if (o == "minimize") {
