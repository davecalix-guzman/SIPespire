...
(function($) {
    ...
    Clockface.prototype = {
        ...
        init: function() {
            ...
            if (this.isInline) {
                ...
                $(document).off('click.clockface').on('click.clockface',
                    $.proxy(function(e) {
                            var $target = $(e.target);
       ...
       */
        ...
        */
        ...
        prepareRegexp: function() {
            ...
            this.regexpSep = (this.separator && this.separator.length)
                ? new RegExp('(\\d\\d?)\\s*\\' + this.separator + '\\s*(\\d?\\d?)\\s*(a|p)?', 'i')
                : null;
    ...
    $.fn.clockface.template = '' +
        ...
        '<div class="cell left"></div>' +
        '<div class="cell right"></div>' +
        '<div class="center"><a  class="ampm"></a></div>' +
        '</div>' +
        '<div class="l4">' +
        '<div class="cell left"></div>' +
        '<div class="cell right"></div>' +
