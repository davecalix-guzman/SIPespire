 ...
 */
    ...
    Shuffle.prototype = {
        ...
        _setTransition: function(element) {
            element.style[TRANSITION] = CSS_TRANSFORM +
                ' ' +
                this.speed +
                'ms ' +
                this.easing +
        ...
        _setSequentialDelay: function($collection) {
            ...
            $.each($collection,
                function(i, el) {
                    ...
                    $(el).on(TRANSITIONEND + '.' + self.unique,
                        function(evt) {
        ...
        _startItemAnimation: function($item, styles, callback) {
            ...
            var complete = $.proxy(this._handleItemAnimationEnd,
                this,
                callback || $.noop,
                $item[0],
                willBeVisible);
        ...
        _processStyleQueue: function() {
            ...
            $.each(this.styleQueue,
                function(i, transitionObj) {

                    if (transitionObj.skipTransition) {
                        self._skipTransition(transitionObj.$item[0],
                            function() {
...
// Overrideable options
    Shuffle.options = {
        ...
        columnWidth:
            0, // a static number or function that returns a number which tells the plugin how wide the columns are (in pixels)
        delimeter: null, // if your group is not json, and is comma delimeted, you could set delimeter to ','
        buffer: 0, // useful for percentage based heights when they might not always be exactly the same (in pixels)
        initialSort:
            null, // Shuffle can be initialized with a sort object. It is the same object given to the sort method
        throttle:
            throttle, // By default, shuffle will try to throttle the resize event. This option will change the method it uses
